...
\item Installieren Sie nun den FixPack 4 gemäß der Anleitung. Bezugsquelle für den Fix ist:\\
\url{http://www-3.ibm.com/cgi-bin/db2www/data/db2/udb/winos2unix/support/download.d2w/report}\\[2ex]
Die wichtigsten Schritte sind:
\begin{itemize}
\item Zuerst müßen sie die Schritte durchführen, die im Readme des Fixpaks beschreiben sind um die Datenbank zu beenden.
...
\item Installieren Sie nun den FixPack 4 gemäß der Anleitung. Dieses Update ist sehr einfach zu bewerkstelligen.\\[2ex]
Die wichtigsten Schritte sind:
\begin{itemize}
\item  Auspacken des FixPack's
\item {\tt ./nsesetup.sh}
