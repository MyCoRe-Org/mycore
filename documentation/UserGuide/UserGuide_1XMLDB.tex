...
\end{verbatim}   
\item Im Verzeichnis \mcrpath{\$MYCORE\_SAMPLE\_HOME} den Befehl \mcrcommand{ant class} ausführen. Dieser Befehl läd
die Classifiactions in die MySQL--Datenbank.
