...
Die folgende Beschreibung erläutert die Arbeit unter SuSE Linux, getestet wurde unter der Version 8.2. Sollten für RedHat Abweichungen auftreten, so werder diese gesondert vermerkt.
