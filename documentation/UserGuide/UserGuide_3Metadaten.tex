...
\lstset{language=XML,fancyvrb=true,frame=btlr,breaklines,prebreak={\space\MyHookSign}}
\begin{lstlisting}[caption=XML-Syntax des Metadaten-Basistypes MCRMetaBollean,label=lst:xml_syntax_basistyp_mcrbolean]
...
\lstset{language=XML,fancyvrb=true,frame=btlr,breaklines,prebreak={\space\MyHookSign}}
\begin{lstlisting}[caption=Beispiel des Metadaten-Basistypes MCRMetaBollean, label=lst:beispiel_basistyp_mcrbolean]
