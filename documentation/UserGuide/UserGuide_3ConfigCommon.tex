...
zu Ihrer Datenbank festlegt. Beachten Sie dabei insbesondere, dass meist Gross/Kleinschreibung relevant ist!
...
Starten Sie nun den eXist-Client und führe Sie folgende Kommandos zum anlegen der Stores unter eXist aus:
...
In der Grundkonfiguration verwendet die Beispiel-Applikation zur Speicherung der Datei-Inhalte
der Derivate das lokale Dateisystem. Passen Sie in der Datei \\
