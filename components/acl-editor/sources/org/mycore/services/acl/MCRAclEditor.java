...
public abstract class MCRAclEditor {
    ...
    public abstract Element getACLEditor(HttpServletRequest request); // Complete

    // ACL-editor
    // public abstract Element getPermEditor(HttpServletRequest request); //
    // Editor for mapping
    // public abstract Element getRuleEditor(HttpServletRequest request); //
    // Editor for rules
