...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xalan" xmlns:java="http://xml.apache.org/xalan/java"
                                        ...
                                        <tr>
                                            <td>
                                                <xsl:variable name="delURL">
                                                    <xsl:value-of
                                                        select="concat($dataRequest, '&amp;action=delAllPerms&amp;objid=',//objid,'&amp;acpool=',//acpool,$redirectURL)" />
                                                </xsl:variable>
                                                <form id="delAllAclPermsForm" name="MappingTableForm" xmlns:encoder="xalan://java.net.URLEncoder"
                                                    ...
                                                    <xsl:when test="not(../@cmd = $edit)">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="ruleSelctBox">
                                                                <!--
                                                                    <div id="{concat('select$',$aclPermTableID)}"> <xsl:value-of select="RID"></xsl:value-of>
                                                                    </div>
                                                                -->
    ...
    <!--
        <xsl:template match="items"> <div id="aclRuleSelBox" class="hidden"> <xsl:for-each select="item"> <div label="{@label}" value="{@value}" />
