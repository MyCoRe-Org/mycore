...
public class MetsModsUtil {
	...
	{
		//<mets:mets xmlns:mets="http://www.loc.gov/METS/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.loc.gov/METS/ http://www.loc.gov/mets/mets.xsd">
		//String mets_head = "<mets:mets xmlns:mets=\"http://www.loc.gov/METS/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xsi:schemaLocation=\"http://www.loc.gov/METS/ http://www.loc.gov/mets/mets.xsd\"></mets:mets>";
	...
	public Element init_mets(String derivate_id)
	{
		...
		if(mets==null) mets = new Element("mets",MCRConstants.METS_NAMESPACE);
	...
	public Element init_mods(String derivate_id, String title, String display, String place, String date)
	{
		...
		originInfo.addContent(new Element("place",MCRConstants.MODS_NAMESPACE).addContent(new Element("placeTerm",MCRConstants.MODS_NAMESPACE).setAttribute("type","text").setText(place)));
		originInfo.addContent(new Element("dateIssued",MCRConstants.MODS_NAMESPACE).setAttribute("keyDate","yes").setAttribute("encoding","w3cdtf").setText(date));
