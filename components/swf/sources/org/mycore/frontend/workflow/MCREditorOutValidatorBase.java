 ...
 */
public class MCREditorOutValidatorBase {
    ...
    protected static Logger LOGGER = Logger.getLogger(MCREditorOutValidator.class);
    ...
    static {
        ...
        Method[] m = MCREditorOutValidatorBase.class.getDeclaredMethods();
        ...
        m = MCREditorOutValidator.class.getDeclaredMethods();
        for (int i = 0; i < m.length; i++) {
            if (!m[i].getName().startsWith("checkMCR")
                    || !((m[i].getParameterTypes().length == 1) && m[i].getParameterTypes()[0] == Element.class && m[i].getReturnType() == Boolean.TYPE)) {
                continue;
     ...
     *            editor input
     */
    public MCREditorOutValidatorBase(Document jdom_in, MCRObjectID id) {
    ...
    protected boolean checkMetaTags(Element datatag) {
    ...
    protected boolean checkMetaObject(Element datasubtag, Class<? extends MCRMetaInterface> metaClass) {
        try {
    ...
    protected boolean checkMetaObjectWithLang(Element datasubtag, Class<? extends MCRMetaInterface> metaClass) {
    ...
    protected boolean checkMetaObjectWithLangNotEmpty(Element datasubtag, Class<? extends MCRMetaInterface> metaClass) {
    ...
    protected boolean checkMetaObjectWithLinks(Element datasubtag, Class<? extends MCRMetaInterface> metaClass) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaBoolean(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaPersonName(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaInstitutionName(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaAddress(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaNumber(Element datasubtag) {
     ...
     */
    @SuppressWarnings("unchecked")
    protected boolean checkMCRMetaHistoryDate(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaLinkID(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaLink(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaClassification(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaISO8601Date(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaAccessRule(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaNBN(Element datasubtag) {
     ...
     * @param datasubtag
     */
    protected boolean checkMCRMetaISBN(Element datasubtag) {
     ...
     */
    @SuppressWarnings("unchecked")
    protected void checkObjectService(Element root, Element service) {
        if (service == null) {
     ...
     */
    @SuppressWarnings("unchecked")
    protected void setDefaultObjectACLs(org.jdom.Element service) {
     ...
     */
    @SuppressWarnings("unchecked")
    protected void checkObjectMetadata(Element metadata) {
     ...
     */
    @SuppressWarnings("unchecked")
    protected void checkObjectStructure(Element structure) {
