...
public class MCRImportClassificationResolver extends MCRImportAbstractMetadataResolver {
    ...
    protected boolean checkValidation() {
        ...
        String classid = metadataChild.getAttributeValue("classid");
        if(classid == null || classid.equals("")) {
            String msg =    "Couldnt map classification element fields " + map.getAttributeValue("field") +
        ...
        String categid = metadataChild.getAttributeValue("categid");
