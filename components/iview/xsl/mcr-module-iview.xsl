...
<!-- ============================================== -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:i18n="xalan://org.mycore.services.i18n.MCRTranslation" xmlns:mcrxml="xalan://org.mycore.common.xml.MCRXMLFunctions" version="1.0" exclude-result-prefixes="xlink i18n mcrxml">
              ...
              <td>
                <table id="naviArea" class="outerMenu">
                  ...
                  <xsl:if test="$MCR.Module-iview.display = 'extended' ">
                    ...
                    <tr>
                      <td colspan="4" id="iview-baseline"/>
                    </tr>
                  </xsl:if>
                </table>
              </td>
      ...
      <tr>
        <td align="center">
          ...
          <xsl:for-each select="/mcr-module/iview/content/nodes/node[@type='file']">
            ...
            <a href="{concat($currentNode,$HttpSession,'?mode=generateLayout&amp;XSL.MCR.Module-iview.style.SESSION=image&amp;XSL.MCR.Module-iview.move=reset' )}">
              <xsl:choose>
