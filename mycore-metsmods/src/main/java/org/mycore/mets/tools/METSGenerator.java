/* $Revision: 3272 $ 
 * $Date: 2011-01-13 16:07:37 +0100 (Thu, 13 Jan 2011) $ 
...
public class METSGenerator {
    ...
    private static void addFolder(MCRDirectory dir, Set<MCRFilesystemNode> ignoreNodes, Element fileGrp, Element physSequence, Element logicalContainer,
        Element structLink, int logCounter) throws URISyntaxException {
