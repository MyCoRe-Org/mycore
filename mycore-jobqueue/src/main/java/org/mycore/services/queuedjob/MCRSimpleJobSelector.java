...
/// A [MCRSimpleJobSelector] is a [MCRJobSelector] that combines simple but commonly required selection criteria.
///  - Jobs that have an action that is one of or none of a given set of actions.
///  - Jobs that have a status that is one of or none of a given set of statuses.
///  - Jobs that were added at least a given number of days ago.
/// 
/// If automatically configured:
/// - The configuration suffix [MCRSimpleJobSelector#ACTIONS_KEY] can be used to specify
///   the set of fully qualified action class names to be considered.
/// - The configuration suffix [MCRSimpleJobSelector#ACTION_MODE_KEY] can be used to specify
///   the set {@link Mode} to be used in conjunction with the set of action class names.
/// - The configuration suffix [MCRSimpleJobSelector#STATUSES_KEY] can be used to specify
///   the set of {@link MCRJobStatus} names to be considered.
/// - The configuration suffix [MCRSimpleJobSelector#STATUS_MODE_KEY] can be used to specify
///   the set {@link Mode} to be used in conjunction with the set of statuses.
/// - The configuration suffix [MCRSimpleJobSelector#AGE_DAYS_KEY] can be used to specify
///   the number of days to be used (where `0` disables the criteria).
/// 
/// Example:
/// ```properties
...
public final class MCRSimpleJobSelector implements MCRJobSelector {
    ...
    public MCRSimpleJobSelector(List<Class<? extends MCRJobAction>> actions, Mode actionMode,
        ...
        this(new HashSet<>(Objects.requireNonNull(actions, "Actions must not be null")), actionMode,
            new HashSet<>(Objects.requireNonNull(statuses, "Statuses must not be null")), statusMode, ageDays);
    }
    ...
    public MCRSimpleJobSelector(Set<Class<? extends MCRJobAction>> actions, Mode actionMode,
        ...
        this.statuses = new HashSet<>(Objects.requireNonNull(statuses, "Statuses must not be null"));
    ...
    public static class Factory implements Supplier<MCRSimpleJobSelector> {
        ...
        public MCRSimpleJobSelector get() {
            ...
            Set<Class<? extends MCRJobAction>> actions = splitValue(this.actions)
                .map(this::toActionJobClass).collect(Collectors.toSet());
            Mode actionMode = Mode.valueOf(this.actionMode);

            Set<MCRJobStatus> statuses = splitValue(this.statuses)
