...
define("mycore/common/common-all", [
	"./CompoundEdit",
	"./EventDelegator",
	"./I18nStore",
	"./I18nResolver",
...
define("mycore/common/CompoundEdit", [
...
define("mycore/common/UndoableEdit", [
	"dojo/_base/declare" // declare
], function(declare) {
...
define("mycore/common/EventDelegator", [
	"dojo/_base/declare", // declare
...
define("mycore/common/I18nStore", [
	"dojo/_base/declare", // declare
...
define("mycore/common/I18nResolver", [
	"dojo/_base/declare", // declare
	"dojo/dom-attr", // attr
	"dojo/dom-construct",
	"mycore/util/DOMUtil",
...
], function(exports, declare, lang, Deferred, domConstruct, query) {
...
define("mycore/common/I18nManager", [
    "dojo/_base/declare",
    "dojo/cookie",
    "dojo/_base/json",
...
define("mycore/common/Preloader", [
	"dojo/_base/declare", // declare
	"dojo/Evented", // to use on.emit
	"dojo/on", // on
	"dojo/_base/lang" // hitch, clone
...
define("mycore/common/UndoableMergeEdit", [
	"dojo/_base/declare", // declare
	"dojo/_base/lang", // hitch
	"mycore/common/UndoableEdit"
...
define("mycore/common/UndoManager", [
	"dojo/_base/declare", // declare
	"dojo/on" // on
], function(declare, on) {
...
define("mycore/dijit/AbstractDialog", [
	"dojo/_base/declare", // declare
	"dijit/Dialog",
	"dojo/on", // on
	"dojo/_base/lang", // hitch
...
define("mycore/dijit/ExceptionDialog", [
	"dojo/_base/declare", // declare
...
define("mycore/dijit/SimpleDialog", [
	"dojo/_base/declare", // declare
...
define("mycore/dijit/RepeaterRow", [
	"dojo/_base/declare", // declare
	"dijit/_Widget",
	"dijit/_Templated",
	"dojo/Evented", // to use on.emit
