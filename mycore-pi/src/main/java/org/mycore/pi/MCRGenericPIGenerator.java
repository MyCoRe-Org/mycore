 ...
 *   </li>
 *   <li>
 *     The replacement marker {@link MCRGenericPIGenerator#PLACE_HOLDER_OBJECT_BASE}
 *     will be replaced with the object IDs {@link MCRObjectID#getBase()}, mapped by the given base mapping.
 *   </li>
 *   <li>
 ...
 * {@link MCRGenericPIGenerator#DEFAULT_DATE_FORMAT} and locale {@link MCRGenericPIGenerator#DFAULT_DATE_LOCALE}).
 * <li> The property suffix {@link MCRGenericPIGenerator#OBJECT_BASE_MAPPING_KEY} can be used to
 * specify the ID base mappings to be used.
 ...
 * [...].ObjectBaseMapping.mycore_mods=MCRMODS
...
public class MCRGenericPIGenerator extends MCRPIGenerator<MCRPersistentIdentifier> {
    ...
    public static final String OBJECT_BASE_MAPPING_KEY = "ObjectBaseMapping";
    ...
    public static final String PLACE_HOLDER_OBJECT_BASE = "$ObjectBase";
    ...
    private final Map<String, String> idBaseMappings;
    ...
    public MCRGenericPIGenerator(String generalPattern, MCRDateFormatter dateFormatter,
        Map<String, String> idBaseMappings, Map<String, String> projectIdMappings,
        Map<String, String> typeIdMappings, int countPrecision, String type, List<String> xPaths) {
        ...
        this.idBaseMappings = Objects.requireNonNull(idBaseMappings, "ID base mappings must not be null");
    ...
    public MCRPersistentIdentifier generate(MCRBase base, String additional)
        ...
        if (resultingPI.contains(PLACE_HOLDER_OBJECT_BASE)) {
            final String idBase = base.getId().getBase();
            final String mappedIdBase = idBaseMappings.getOrDefault(idBase, idBase);
            resultingPI = resultingPI.replace(PLACE_HOLDER_OBJECT_BASE, mappedIdBase);
        }
    ...
    private String applyCount(String resultingPI) {
        ...
        if (resultingPI.contains(PLACE_HOLDER_COUNT)) {
            ...
            DecimalFormat decimalFormat =
                new DecimalFormat(pattern, DecimalFormatSymbols.getInstance(DFAULT_DATE_LOCALE));
    ...
    public static class Factory implements Supplier<MCRGenericPIGenerator> {
        ...
        @MCRPropertyMap(name = OBJECT_BASE_MAPPING_KEY, required = false)
        public Map<String, String> idBaseMappings;
        ...
        public MCRGenericPIGenerator get() {
            return new MCRGenericPIGenerator(generalPattern, getFormatter(), idBaseMappings, projectIdMappings,
                typeIdMappings, Integer.parseInt(countPrecision), type, xPaths);
        }

        private MCRDateFormatter getFormatter() {
            return dateFormatter != null ? dateFormatter
                : new MCRSimpleDateFormatter(DEFAULT_DATE_FORMAT, DFAULT_DATE_LOCALE);
        }
