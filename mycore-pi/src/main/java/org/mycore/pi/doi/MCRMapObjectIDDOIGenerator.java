 ...
 *
 */
public class MCRMapObjectIDDOIGenerator implements MCRPersistentIdentifierGenerator<MCRDigitalObjectIdentifier> {
    ...
    public MCRDigitalObjectIdentifier generate(MCRObjectID mcrID, String additional)
        ...
        String prefixProperty = "MCR.PI.Generator.MapObjectIDDOI.Prefix." + mcrID.getBase();
