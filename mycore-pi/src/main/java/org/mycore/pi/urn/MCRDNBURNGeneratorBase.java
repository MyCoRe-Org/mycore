...
public abstract class MCRDNBURNGeneratorBase implements MCRPIGenerator<MCRDNBURN> {
    ...
    protected abstract String buildNISS(MCRBase base, String additional) throws MCRPersistentIdentifierException;
