...
public class MCRAudioObject  extends MCRMediaObject {
    ...
    public int getStreamBitRate() {
        ...
        int calcBitRate = ( parentContainer != null ? ((MCRVideoObject)parentContainer).bitRate - ((MCRVideoObject)parentContainer).streamBitRate : 0 );
    ...
    public Element toXML( boolean withRoot ) {
        ...
        if ( withRoot ) {
            ...
            if (format != null ) contformat.setAttribute("type", format);
            if (formatFull != null )contformat.setAttribute("description", formatFull);
