...
import org.mycore.mcr.acl.accesskey.access.MCRAccessKeyAccessConstants;
...
@Path("access-keys")
public class MCRAccessKeyGenericRestResource {
    ...
    @MCRRestRequiredPermission(MCRAccessKeyAccessConstants.PERMISSION_MANAGE_ACCESS_KEY)
    public List<MCRAccessKeyDto> getAccessKeys(
        ...
        return MCRAccessKeyRestHelper.getAccessKeys(reference, permission, offset, limit, response);
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @MCRRestRequiredPermission(MCRAccessKeyAccessConstants.PERMISSION_MANAGE_ACCESS_KEY)
    public MCRAccessKeyDto getAccessKeyById(@PathParam(MCRAccessKeyRestConstants.PATH_PARAM_ACCESS_KEY_ID) UUID id) {
    ...
    @MCRRestRequiredPermission(MCRAccessKeyAccessConstants.PERMISSION_MANAGE_ACCESS_KEY)
    public Response createAccessKey(MCRAccessKeyDto accessKeyDto) {
    ...
    @MCRRestRequiredPermission(MCRAccessKeyAccessConstants.PERMISSION_MANAGE_ACCESS_KEY)
    @MCRRequireTransaction
    public Response updateAccessKeyById(@PathParam(MCRAccessKeyRestConstants.PATH_PARAM_ACCESS_KEY_ID) UUID id,
    ...
    @MCRRestRequiredPermission(MCRAccessKeyAccessConstants.PERMISSION_MANAGE_ACCESS_KEY)
    @MCRRequireTransaction
    public Response partialUpdateAccessKeyById(@PathParam(MCRAccessKeyRestConstants.PATH_PARAM_ACCESS_KEY_ID) UUID id,
    ...
    @MCRRestRequiredPermission(MCRAccessKeyAccessConstants.PERMISSION_MANAGE_ACCESS_KEY)
    @MCRRequireTransaction
    public Response deleteAccessKeyById(@PathParam(MCRAccessKeyRestConstants.PATH_PARAM_ACCESS_KEY_ID) UUID id) {
