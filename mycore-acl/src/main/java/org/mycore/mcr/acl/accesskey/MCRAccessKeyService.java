...
public interface MCRAccessKeyService {
    ...
    /**
     * Finds an access key by its reference and value.
     *
     ...
     */
    MCRAccessKeyDto findAccessKeyByReferenceAndValue(String reference, String value);
     ...
     * @throws MCRAccessKeyCollisionException if a key with the same reference and value already exists
     */
     ...
     * @throws MCRAccessKeyNotFoundException if no access key is found with the given ID
     * @throws MCRAccessKeyCollisionException if the updated value conflicts with another access key
     */
    ...
    /**
     * Processes the raw value for a specific reference to create a valid access key value.
     *
     * @param reference the reference of the access key
     * @param rawValue the raw value to process
     * @return the processed value
     */
    String processValue(String reference, String rawValue);
