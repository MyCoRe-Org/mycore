...
public class MCRAccessKeyServiceImpl implements MCRAccessKeyService {
    ...
    @Override
    public MCRAccessKeyDto createAccessKey(MCRAccessKeyDto accessKeyDto) {
    ...
    @Override
    public MCRAccessKeyDto updateAccessKeyById(UUID id, MCRAccessKeyDto accessKeyDto) {
    ...
    @Override
    public void deleteAccessKeyById(UUID id) {
        final MCRAccessKey accessKey = accessKeyRepository.findByUuid(id)
            .orElseThrow(() -> new MCRAccessKeyNotFoundException("access key with given reference does not exist"));
    ...
    public boolean checkAccess(String reference, String rawValue, String permission) {
        ...
        final Optional<MCRAccessKey> accessKeyOpt = accessKeyRepository.findByReferenceAndValue(reference,
            valueProcessor.getValue(reference, rawValue));
