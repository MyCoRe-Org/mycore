 ...
 */
public class MCRAccessKeyJsonMapper {
    ...
    public static String accessKeyDtoToJson(MCRAccessKeyDto accessKeyDto) {
        try {
            return objectMapper.writeValueAsString(accessKeyDto);
    ...
    public static String accessKeyDtosToJson(List<MCRAccessKeyDto> accessKeyDtos) {
        try {
            return objectMapper.writeValueAsString(accessKeyDtos);
        } catch (JsonProcessingException e) {
    ...
    public static MCRAccessKeyDto jsonToAccessKeyDto(String json) {
        try {
            return objectMapper.readValue(json, MCRAccessKeyDto.class);
        } catch (JsonProcessingException e) {
    ...
    public static List<MCRAccessKeyDto> jsonToAccessKeyDtos(String json) {
        try {
            return Arrays.asList(objectMapper.readValue(json, MCRAccessKeyDto[].class));
        } catch (JsonProcessingException e) {
