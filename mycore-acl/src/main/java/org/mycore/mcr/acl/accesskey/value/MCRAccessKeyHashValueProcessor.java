...
public class MCRAccessKeyHashValueProcessor implements MCRAccessKeyValueProcessor {
    ...
    /**
     * Constructs new {@link MCRAccessKeyHashValueProcessor} with given hashing iterations
     *
    ...
    /**
     * This factory creates new {@link MCRAccessKeyHashValueProcessor} and should be called by config.
     */
    public static class Factory implements Supplier<MCRAccessKeyHashValueProcessor> {
        ...
        public MCRAccessKeyHashValueProcessor get() {
            return new MCRAccessKeyHashValueProcessor(Integer.parseInt(hashingIterations));
        }
    }
