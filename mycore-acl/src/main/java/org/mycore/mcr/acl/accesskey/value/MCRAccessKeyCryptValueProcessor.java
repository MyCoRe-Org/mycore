...
/**
 * This {@link MCRAccessKeyCryptValueProcessor} encrypts the concatenation of reference and value.
 */
public class MCRAccessKeyCryptValueProcessor implements MCRAccessKeyValueProcessor {

    @Override
    public String getValue(String reference, String value) {
        try {
            return MCRCipherManager.getCipher("accesskey").encrypt(reference + value);
