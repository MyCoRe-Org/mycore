...
public class MCRAccessKeyPartialUpdateDto {
    ...
    private MCRNullable<String> value = new MCRNullable<>();
    ...
    /**
     * Returns the value associated with the access key.
     *
    ...
    /**
     * Sets the value associated with the access key.
     *
     * @param value a Nullable containing the new value of the access key
     */
    public void setValue(MCRNullable<String> value) {
        this.value = value;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(active, comment, expiration, reference, permission, value);
    }
