...
const dict: Record<string, string> = {
  ...
  'mcr.accessKey.error.collision': 'The secret collides with another key.',
  ...
  'mcr.accessKey.label.created': 'Created',
  'mcr.accessKey.label.createdBy': 'Created by',
  'mcr.accessKey.label.enabled': 'Activated',
  'mcr.accessKey.label.expiration': 'Expiration',
  'mcr.accessKey.label.lastModified': 'Last modified',
  'mcr.accessKey.label.lastModifiedBy': 'Last modified by',
  ...
  'mcr.accessKey.label.secret': 'Value',
  ...
  'mcr.accessKey.popover.secret': 'The <em>secret</em> is used to enable the access key for an user. <br><br><b>Attention</b>: After adding the key may the secret is no longer visible and cannot be changed afterwards.',
  'mcr.accessKey.success.add': 'An access key <b>{0}</b> with secret <b>{1}</b> was successfully added.',
  ...
  'mcr.accessKey.validation.secret': 'The secret is mandatory',
};
