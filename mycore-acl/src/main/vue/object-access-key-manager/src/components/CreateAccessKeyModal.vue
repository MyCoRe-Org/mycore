<template>
  <BaseModal :show="showModal" :title="$t('component.acl.accesskey.frontend.title.createAccessKey')"
...
const reference: string | undefined = inject(objectIdKey);
