...
public class MCRClassificationServiceImplTest extends MCRTestCase {

    public void testCalculateLeftRight() {
        MCRClassificationObject co1 = new MCRClassificationObject();
        assertEquals(2, MCRClassificationServiceImpl.calculateLeftRight(co1, 1));
        MCRClassificationObject co2 = new MCRClassificationObject();
        co1.getChildren().add(co2);
        assertEquals(4, MCRClassificationServiceImpl.calculateLeftRight(co1, 1));
        MCRClassificationObject co3 = new MCRClassificationObject();
        co1.getChildren().add(co3);
        assertEquals(6, MCRClassificationServiceImpl.calculateLeftRight(co1, 1));
