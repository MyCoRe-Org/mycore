(function(){
    ...
    iview.urn.View = (function(){
        ...
        /**
         * @description Creates the urntoolbar in the viewer
         * 				Triggers iview.urn.view.closed on the view.
         */
        constructor.prototype._createToolbar = function urn_createToolbar(){
            ...
            jQuery(this._urnToolBar).ready().append("<div class=\"urnClose\">x</div>");
         ...
         */
        constructor.prototype.updateToolbarText = function urn_updateToolbarText(newText){
        ...
        constructor.prototype.setUrnToolbarVisible = function urn_setUrnToolbarVisible(visible){
            if (visible) {
                if (this._iViewInstance.addDimensionSubstract(true, 'UrnToolbar', 27)) {
                    ...
                    if (this._iViewInstance.thumbnailPanel.loaded) {
                        this._iViewInstance.thumbnailPanel._view.resize();
                    }
                }
    ...
    iview.urn.Controller = (function(){
        ...
        constructor.prototype.updateUrn = function urn_updateUrn(){
            if (this.hasUrn) {
                var currentUrn = this._iViewInstance.PhysicalModel.getCurrent().getContentId();
                this._view.updateToolbarText(currentUrn);
            }
        }
        
        constructor.prototype.urnButtonClicked = function urn_urnButtonClicked(button){
