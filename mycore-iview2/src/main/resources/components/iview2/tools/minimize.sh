...
declare -a sources
sources=( "jquery.mousewheel.min.js" "PanoJS.js" "Event.js" "jquery.tree.min.js" "chapter.js" "overview.js" "XML.js" "Utils.js" "scrollBars.js" "cutOut.js" "METS.js" "Thumbnail.js" "init.js" "../lib/fg-menu/fg.menu.js" "iview2.toolbar/ToolbarImporter.js" "iview2.toolbar/ToolbarManager.js" "iview2.toolbar/ToolbarModel.js" "iview2.toolbar/ToolbarButtonsetModel.js" "iview2.toolbar/ToolbarDividerModel.js" "iview2.toolbar/ToolbarSpringModel.js" "iview2.toolbar/ToolbarTextModel.js" "iview2.toolbar/ToolbarButtonModel.js" "iview2.toolbar/ToolbarController.js" "iview2.toolbar/ToolbarView.js" "iview2.toolbar/StandardToolbarModelProvider.js" "iview2.toolbar/PreviewToolbarModelProvider.js" "Permalink.js" )
...
while { inotifywait -e modify -e create -e move -e delete $srcpath; }; do
	rm -f $destpath
	touch $destpath
	for file in ${sources[@]}
	do
