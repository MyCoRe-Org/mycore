...
/// [MCRArgon2Strategy] is an implementation of [MCRPasswordCheckStrategy] that uses the Argon2 algorithm.
/// 
...
/// - The configuration suffix [MCRArgon2Strategy#SALT_SIZE_BYTES_KEY] can be used to specify
///   the size of generated salt values in bytes.
/// - The configuration suffix [MCRArgon2Strategy#HASH_SIZE_BYTES_KEY] can be used to specify
///   the size of generated hash values in bytes.
/// - The configuration suffix [MCRArgon2Strategy#PARALLELISM_KEY] can be used to specify
///   the parallelization value.
/// - The configuration suffix [MCRArgon2Strategy#MEMORY_LIMIT_KILOBYTES_KEY] can be used to influence
///   the amount of memory to be used in kilobytes.
/// - The configuration suffix [MCRArgon2Strategy#ITERATIONS_KEY] can be used to specify
...
/// [...].Iterations=8
/// ```
/// Changes to the parallelism value, memory limit or number of iterations will result in deviating hashes
