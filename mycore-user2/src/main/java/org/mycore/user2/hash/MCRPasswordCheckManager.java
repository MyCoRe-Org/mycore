...
public final class MCRPasswordCheckManager {
    ...
    public MCRPasswordCheckManager(SecureRandom random, Map<String, MCRPasswordCheckStrategy> strategies,
        ...
        this.strategies = new HashMap<>(Objects
            .requireNonNull(strategies, "Strategies must not be null"));
        this.strategies.forEach((type, strategy) -> Objects
            .requireNonNull(strategy, "Strategy " + type + " must not be null"));
        this.selectedStrategyType = Objects
            .requireNonNull(selectedStrategyType, "Selected strategy must not be null");
