...
/// [MCRCryptStrategy] is an implementation of [MCRPasswordCheckStrategy] that uses the traditional
/// DES-based password hashing scheme of the POSIX C crypt(3) command.
/// 
/// The salt is encoded in the hash using the Modular Crypt Format (MCF) for the traditional
/// DES-based password hashing scheme. No explicit salt values are generated.
/// 
