...
/**
 * A {@link MCRSHA1Strategy} is a {@link MCRPasswordCheckStrategy} that uses the SHA1 algorithm.
 * <p>
 * The salt is returned as a base 64 encoded string. The hash is returned as a hex encoded string.
 * <p>
 * The following configuration options are available,:
 * <ul>
 * <li> The property suffix {@link MCRSHA1Strategy#SALT_SIZE_BYTES_KEY} can be used to
 * specify the size of generated salt values in bytes.
 * <li> The property suffix {@link MCRSHA1Strategy#ITERATIONS_KEY} can be used to
