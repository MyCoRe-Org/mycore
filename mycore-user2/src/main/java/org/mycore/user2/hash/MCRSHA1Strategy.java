...
/// [MCRSHA1Strategy] is an implementation of [MCRPasswordCheckStrategy] that uses the SHA1 algorithm.
/// 
/// The salt is returned as a base 64 encoded string. The hash is returned as a hex encoded string.
/// 
/// The following configuration options are available, if configured automatically:
/// 
/// - The configuration suffix [MCRSHA1Strategy#SALT_SIZE_BYTES_KEY] can be used to specify
///   the size of generated salt values in bytes.
/// - The configuration suffix [MCRSHA1Strategy#ITERATIONS_KEY] can be used to specify
