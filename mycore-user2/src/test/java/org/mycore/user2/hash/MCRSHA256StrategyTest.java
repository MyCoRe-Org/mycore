...
public class MCRSHA256StrategyTest extends MCRTestCase {

    public static final String TYPE = "type";

    public static final String PASSWORD = "passwd123";

    public static final int SHA256_HASH_STRING_LENGTH = 64;
    ...
    public final void test() {
        ...
        assertEquals(SHA256_HASH_STRING_LENGTH, data.hash().length());
    ...
    public final void testSaltSizeChange() {
        ...
        MCRPasswordCheckStrategy strategyOld = new MCRSHA256Strategy(8, 1);
        MCRPasswordCheckStrategy strategyNew = new MCRSHA256Strategy(16, 1);
    ...
    public final void testIterationsChange() {
        ...
        MCRPasswordCheckStrategy strategyOld = new MCRSHA256Strategy(8, 1);
        MCRPasswordCheckStrategy strategyNew = new MCRSHA256Strategy(8, 2);
        MCRPasswordCheckData dataOld = strategyOld.create(new SecureRandom(), TYPE, PASSWORD);
