...
public class MCRUserCopyTest {
    ...
    public void testClone() throws CloneNotSupportedException {
        ...
        assertEquals(employee.getPassword(), employeeCopy.getPassword());
        ...
        assertEquals(employee.getEMailAddress(), employeeCopy.getEMailAddress());
        ...
        assertEquals(boss.getPassword(), bossCopy.getPassword());
        ...
        assertEquals(boss.getEMailAddress(), bossCopy.getEMailAddress());
    ...
    public void testSafeCopy() {
        ...
        assertNull(employeeCopy.getPassword());
        ...
        assertNull(bossCopy.getPassword());
    ...
    public void testBasicCopy() {
        ...
        assertEquals(employee.getRealmID(), employeeCopy.getRealmID());
        assertNull(employeeCopy.getRealName()); // <-- information not present
        assertNull(employeeCopy.getEMailAddress());
        assertNull(employeeCopy.getLastLogin());
        ...
        assertEquals(boss.getRealmID(), bossCopy.getRealmID());
        assertNull(bossCopy.getRealName()); // <-- information not present
        assertNull(bossCopy.getEMailAddress());
        assertNull(bossCopy.getLastLogin());
    ...
    private static MCRUser createUser(String realName, String id, MCRUser owner, String... roles) {
        ...
        user.setPassword("thePassword-" + id); // <-- actually, the password hash
