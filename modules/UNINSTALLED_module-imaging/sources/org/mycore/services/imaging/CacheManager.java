...
public interface CacheManager {
	 ...
	 * @param filename the cache version thumbnail etc.
	 * @param imageData	the cached image
	 */
	 ...
	 * @param image the original image
	 * @param filename the cache version
	 * @param imageData the cached image
	 */
	 ...
	 * @param image the original image
	 * @param filename the cache version of the original image
	 */
