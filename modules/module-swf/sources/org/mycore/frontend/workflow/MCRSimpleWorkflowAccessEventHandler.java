...
public class MCRSimpleWorkflowAccessEventHandler extends MCREventHandlerBase {
    ...
    protected void handleObjectCreated(MCREvent evt, MCRObject obj) {
        ...
        MCRSimpleWorkflowAccess.getAccessRule(MCRSimpleWorkflowAccess.READ_POOL,serv);
        MCRSimpleWorkflowAccess.getAccessRule(MCRSimpleWorkflowAccess.WRITE_POOL,serv);
        MCRSimpleWorkflowAccess.getAccessRule(MCRSimpleWorkflowAccess.WRITEWF_POOL,serv);
        MCRSimpleWorkflowAccess.getAccessRule(MCRSimpleWorkflowAccess.DELETE_POOL,serv);
        MCRSimpleWorkflowAccess.getAccessRule(MCRSimpleWorkflowAccess.DELETEWF_POOL,serv);
        MCRSimpleWorkflowAccess.getAccessRule(MCRSimpleWorkflowAccess.COMMIT_POOL,serv);
