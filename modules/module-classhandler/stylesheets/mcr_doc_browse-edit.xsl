...
<!-- ============================================== -->
<!-- $Revision: 1.2.2.2 $ $Date: 2006-09-26 12:02:49 $ -->
<!-- ============================================== -->
...
<xsl:for-each select="navigationtree">	
 ...
 <tr><td>
  ...
  <xsl:for-each select="row">
   ...
   <xsl:variable name="href2" select="concat($ServletsBaseURL, 'MCRSearchServlet',$HttpSession,'?query=(',$type,'+=+', col[2]/@lineID, ')+and+(objectType+=+document)&amp;numPerPage=10','&amp;mask=browse/',$type)" />
