						...
						<table class="table_noGrid" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
							...
							<tr>
								<td class="green_noBorder" align="center" colspan="2">
									<b> Bitte legen sie zun�hst fest, was sie machen wollen und auf welche Seite sich 
	...
	<xsl:template name="error">
		...
		<tr>
			<th colspan="2" class="red" align="left">
				<b>
					<xsl:choose>
						<xsl:when test=" /cms/error = '0' or /cms/error = '9' " > Fehler aufgetreten: Keine Seite ausgew�lt. 
							<br/><br/> Bitte w�len sie in der 2. Box die Seite aus, die sie bearbeiten wollen. </xsl:when>
						<xsl:when test=" /cms/error = '5' " > Fehler aufgetreten: Anlegen nicht m�lich. <br/><br/> Auf dieser 
							Ebene k�nen keine weiteren Menpunkte angelegt werden. W�len sie beim Erstellen die Position 
							"darunter" aus. </xsl:when>
						<xsl:when test=" /cms/error = '6' " > Fehler aufgetreten: Anlegen nicht m�lich. <br/><br/> Unterhalb 
							eines externen Linkes k�nen keine weiteren Menpunkte angelegt werden. </xsl:when>
						<xsl:when test=" /cms/error = '7' " > Fehler aufgetreten: L�chen nicht m�lich. <br/><br/> Ein 
							Menpunkt kann nur gel�cht werden, wenn er keine Untermenpunkte mehr enth�t. </xsl:when>
						<xsl:when test=" /cms/error = '8' " > Fehler aufgetreten: Keine Berechtigung. <br/><br/> Sie k�nen in 
							der gew�lten Menebene keinen Inhalt pflegen. </xsl:when>
					</xsl:choose>
				</b>
			</th>
		</tr>
				...
				<table cellspacing="0" border="0" cellpadding="0" align="right" class="wcms">
					...
					<tr>
						...
						<td align="right" class="button">
							<a href="javascript:document.choose.submit()">weiter zum n�hsten Schritt</a>
						</td>
						<td align="right">
							<img 
