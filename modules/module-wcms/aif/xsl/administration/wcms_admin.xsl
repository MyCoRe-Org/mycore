...
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td colspan="2">
	 ...
	 <br/><br/>	 
	 <img src="{$ImageBaseURL}greenArrow.gif" width="16" height="8" border="0" alt="" title=""/>
	 <a href="{$ServletsBaseURL}WCMSAdminServlet?action=choose">Verwaltung der Webpräsenz</a>
	 <br/>
	 <img src="{$ImageBaseURL}greenArrow.gif" width="16" height="8" border="0" alt="" title=""/>
<!-- 	 <a href="/common/wcms/logs.xml">Nutzungsstatistik einsehen</a> -->
