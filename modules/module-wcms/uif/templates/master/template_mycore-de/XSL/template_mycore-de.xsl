...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" 
	...
	<xsl:template name="template_mycore-de">
					...
					<tr valign="top">
								...
								<tr valign="top">
									<td colspan="2">
										<a href="{$WebApplicationBaseURL}">
											<img src="{$ImageBaseURL}logo.gif" width="220" height="117" border="0" 
												alt="" />
										</a>
									</td>
								</tr>
						...
						<td height="100%">
							<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr valign="top">
									<td height="100%">
										<xsl:call-template name="template_mycoresample.write.content">
											<xsl:with-param name="browserAddress" select="$browserAddress"/>
	...
	<!-- ================================================================================= -->
	<xsl:template name="template_mycoresample.write.content">
		<xsl:param name="browserAddress" />
		<xsl:param name="template" />		
