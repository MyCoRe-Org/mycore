...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template match="TOC | toc">
		...
		<xsl:for-each 
			...
			<xsl:for-each select="child::item">
				<img src="{$WebApplicationBaseURL}modules/module-wcms/uif/common/images/naviGeneral/greenArrow.gif" />
	...
	<xsl:template name="addIcon">
		...
		<xsl:choose>
			...
			<xsl:when test="count(following-sibling::item) &lt; 1">
				<xsl:choose>
					<xsl:when test="$linkKind = 'line'" >
						<img src="{$ImageBaseURL}naviTree/empty-ri.gif" width="{$columnWidthIcon}" height="{$menuPointHeigth}" 
							border="0" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'normal'" >
						<img src="{$ImageBaseURL}naviTree/line-with-element_end.gif" width="{$columnWidthIcon}" 
							height="{$menuPointHeigth}" border="0" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'current'" >
						<img src="{$ImageBaseURL}naviTree/line-with-element-selected_end.gif" width="{$columnWidthIcon}" 
							height="{$menuPointHeigth}" border="0" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'current_popedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after((parent::node()/@href),'/'))}" target="{@target}">
							<img src="{$ImageBaseURL}naviTree/minus-selected_end.gif" width="{$columnWidthIcon}" 
								height="{$menuPointHeigth}" border="0" alt="" title=""></img>
						</a>
					</xsl:when>
					<xsl:when test="$linkKind = 'popedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after((parent::node()/@href),'/'))}" target="{@target}">
							<img src="{$ImageBaseURL}naviTree/minus_end.gif" width="{$columnWidthIcon}" height="{$menuPointHeigth}" 
								border="0" alt="" title=""></img>
						</a>
					</xsl:when>
					<xsl:when test="$linkKind = 'notPopedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after(@href,'/'))}" target="{@target}">
							<img src="{$ImageBaseURL}naviTree/plus_end.gif" width="{$columnWidthIcon}" height="{$menuPointHeigth}" 
								border="0" alt="" title="" />
						</a>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:otherwise>
				<xsl:choose>
					<xsl:when test="$linkKind = 'line'" >
						<img src="{$ImageBaseURL}naviTree/line.gif" width="{$columnWidthIcon}" height="{$menuPointHeigth}" border="0" 
							alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'normal'" >
						<img src="{$ImageBaseURL}naviTree/line-with-element.gif" width="{$columnWidthIcon}" 
							height="{$menuPointHeigth}" border="0" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'current'" >
						<img src="{$ImageBaseURL}naviTree/line-with-element-selected.gif" width="{$columnWidthIcon}" 
							height="{$menuPointHeigth}" border="0" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'current_popedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after((parent::node()/@href),'/'))}" target="{@target}">
							<img src="{$ImageBaseURL}naviTree/minus-selected.gif" width="{$columnWidthIcon}" 
								height="{$menuPointHeigth}" border="0" alt="" title=""></img>
						</a>
					</xsl:when>
					<xsl:when test="$linkKind = 'popedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after((parent::node()/@href),'/'))}" target="{@target}">
							<img src="{$ImageBaseURL}naviTree/minus.gif" width="{$columnWidthIcon}" height="{$menuPointHeigth}" 
								border="0" alt="" title=""></img>
						</a>
					</xsl:when>
					<xsl:when test="$linkKind = 'notPopedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after(@href,'/'))}" target="{@target}">
							<img src="{$ImageBaseURL}naviTree/plus.gif" width="{$columnWidthIcon}" height="{$menuPointHeigth}" 
								border="0" alt="" title="" />
						</a>
					</xsl:when>
				</xsl:choose>
	...
	<xsl:template name="generateFlagButton">
		<xsl:variable name="englishFlag">
			<img src="{$WebApplicationBaseURL}modules/module-wcms/uif/common/images/lang-en.gif" alt="new language: English" 
				title="Union Jack" style="width:24px; height:12px; vertical-align:bottom; border-style:none;" />
		</xsl:variable>
		<xsl:variable name="germanFlag">
			<img src="{$WebApplicationBaseURL}modules/module-wcms/uif/common/images/lang-de.gif" alt="new language: German" 
				title="Deutsch" style="width:24px; height:12px; vertical-align:bottom; border-style:none;" />
		</xsl:variable>
		<xsl:choose>
