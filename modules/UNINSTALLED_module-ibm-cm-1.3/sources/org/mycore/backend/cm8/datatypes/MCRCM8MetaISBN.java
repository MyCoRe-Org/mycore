 ...
 * data model type MetaISBN.
 * 
 * @author Thomas Scheffler (yagee)
 * @version $Revision$ $Date$
 */
public class MCRCM8MetaISBN extends MCRAbstractCM8ComponentType {
    ...
    public DKComponentTypeDefICM createComponentType(final org.jdom.Element element) throws DKException, Exception {
        ...
        typeDef.addAttr(getVarCharAttr("mcrISBN", "International Standard Book Number", attrSize));
        return typeDef;
    }
