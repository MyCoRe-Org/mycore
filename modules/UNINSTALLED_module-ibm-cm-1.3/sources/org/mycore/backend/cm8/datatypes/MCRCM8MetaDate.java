 ...
 * data model type MetaDate.
 * 
 * @author Thomas Scheffler (yagee)
 * @version $Revision$ $Date$
 */
public class MCRCM8MetaDate extends MCRAbstractCM8ComponentType {
    public DKComponentTypeDefICM createComponentType(final org.jdom.Element element) throws DKException, Exception {
        ...
        typeDef.addAttr(getDateAttr("mcrDate", getAttrDescription(element)));
        return typeDef;
    }

    private DKAttrDefICM getDateAttr(final String name, final String description) throws Exception, DKException {
        MCRCM8AttributeUtils.createAttributeDate(getDsDefICM(), name);
