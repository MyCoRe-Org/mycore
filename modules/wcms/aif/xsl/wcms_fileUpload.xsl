...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xalan" >
	...
	<xsl:template name="wcmsFileUpload.upload" >
		<form name="documentUpload" method="POST" action="{$WebApplicationBaseURL}servlets/MCRWCMSFileUploadServlet{$HttpSession}" 
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<tr>
				<td colspan="2">
					<br/>
					<br/>
					<a href="{$WebApplicationBaseURL}modules/wcms/aif/web/multimedia.xml">zurück zum WCMS</a>
