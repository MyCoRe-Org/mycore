...
/**
 * Provides some constants like namespaces, schema location, error codes and so
 * on as defined by the OAI-PMH 2.0 protocol.
 * 
...
class MCROAIConstants {
    ...
    final static String DELETED_RECORD_POLICY_NO = "no";

    final static String DELETED_RECORD_POLICY_TRANSIENT = "transient";

    final static String DELETED_RECORD_POLICY_PERSISTENT = "persistent";
}
