...
public class MCRUploadProgressMonitor extends JDialog {
     ...
     */
    protected MCRUploadProgressMonitor(int numFiles, long sizeTotal,
    ...
    protected void update() {
        ...
        final String sFile = formatSize(bytesFile) + " von "
                + formatSize(sizeFile) + " übertragen";
        ...
        final String sTotal = formatSize(bytesTotal) + " von "
                + formatSize(sizeTotal) + " insgesamt übertragen";
        ...
        if (canceled) {
            ...
            sTime = "Dauer bisher " + formatTime(sec) + " / geschätzt noch "
                    + formatTime(rest);
        } else {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MCRUploadProgressMonitor upm = new MCRUploadProgressMonitor(numFiles,
                sizeTotal, null);
