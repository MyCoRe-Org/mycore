...
/**
 * This class handles upload of files.
 * Subclasses handle storage of files.
 *
...
public abstract class MCRUploadHandlerBase
{
  ...
  { if ((id!=null) && ((id=id.trim()).length()!=0)) { uploadId = id;} }
  ...
  public abstract String receiveFile(String path, InputStream in ) throws Exception;
