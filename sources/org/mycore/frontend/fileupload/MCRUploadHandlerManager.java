...
/**
 * This class manages all handles of file upload as implementation of the
...
public class MCRUploadHandlerManager {
	...
	private static Logger logger = Logger
			.getLogger("org.mycore.frontend.fileupload");
	 ...
	 */
	public static MCRUploadHandlerManager instance() throws MCRException {
		if (singleton == null)
			singleton = new MCRUploadHandlerManager();
		return singleton;
	}
	...
	/**
	 * The method return a new instance of the file upload handler. The used
	 * class is the default class from the configuration.
	 * 
	 * @return a new instance of a file upload handler as
	 *         MCRUploadHandlerInterface implementation
	 */
	...
	/**
	 * The method return a new instance of the file upload handler for the given
	 * handler class name.
	 * 
	 * @return a new instance of a file upload handler as
	 *         MCRUploadHandlerInterface implementation
	 */
	public final MCRUploadHandlerInterface getNewHandle(String name)
			throws MCRException {
		Object obj = null;
		try {
	 ...
	 * 
	 * @param handle
	 *            the instance of MCRUploadHandlerInterface
