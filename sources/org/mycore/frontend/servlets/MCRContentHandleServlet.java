 ...
 * shows single file from ifs upload single file in ifs
 * 
...
public final class MCRContentHandleServlet extends MCRServlet {
    ...
    static final private Logger LOGGER = Logger
            .getLogger(MCRContentHandleServlet.class);
    ...
    public void doGetPost(MCRServletJob job) throws Exception {
        ...
        // editor input?
        MCREditorSubmission sub = (MCREditorSubmission) (req
     ...
     *            node id of ifs
     */
    private void showIFSNode(HttpServletRequest req, HttpServletResponse res,
            String ifsnodeid) throws Exception {
     ...
     * 
     * @param input
     *            from editor servlet, contains query as jdom
     * @return the query for lucene
     */
    private String buildLuceneQuery(org.jdom.Document input) throws Exception {
        String query = "";
        //     XMLOutputter outputter = new XMLOutputter();
        //     outputter.output( input, System.out );
        org.jdom.Element root = input.getRootElement();
            ...
            try {
                ...
                for (int i = 0; i < result.length; i++) {
                    ...
                    if (null == f) {
                        ...
                        org.jdom.Element help = f.getContentAsJDOM()
                                .detachRootElement();
     ...
     * 
     * @param input
     *            from editor servlet, contains filename ... as jdom
     */
    private void doStore(HttpServletRequest req, HttpServletResponse res,
            MCREditorSubmission sub, org.jdom.Document input) throws Exception {
        org.jdom.Element root = input.getRootElement();
