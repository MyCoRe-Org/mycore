...
public class MCRUserCommands extends MCRAbstractCommands {
    ...
    public MCRUserCommands() {
        ...
        com = new MCRCommand("update privileges data from file {0}", "org.mycore.frontend.cli.MCRUserCommands.updatePrivilegesFromFile String", "The command update the privilege data of the user system with data from the file {0}.");
        command.add(com);
        ...
        com = new MCRCommand("add group {0} as member to group {1}", "org.mycore.frontend.cli.MCRUserCommands.addMemberGroupToGroup String String", "");
        command.add(com);

        com = new MCRCommand("remove group {0} as member from group {1}", "org.mycore.frontend.cli.MCRUserCommands.removeMemberGroupFromGroup String String", "");
        command.add(com);

        com = new MCRCommand("add to group {0} the privilege {1}", "org.mycore.frontend.cli.MCRUserCommands.addPrivilegeToGroup String String", "");
        command.add(com);

        com = new MCRCommand("remove from group {0} the privilege {1}", "org.mycore.frontend.cli.MCRUserCommands.removePrivilegeFromGroup String String", "");
        command.add(com);
        ...
        com = new MCRCommand("list all privileges", "org.mycore.frontend.cli.MCRUserCommands.listAllPrivileges", "");
        command.add(com);
        ...
        com = new MCRCommand("save all privileges to file {0}", "org.mycore.frontend.cli.MCRUserCommands.saveAllPrivilegesToFile String", "");
        command.add(com);
    ...
    public static void initSuperuser() throws MCRException {
        ...
        try {
            ...
            privList.add(new MCRPrivilege("create user", "Users with this privilege may create new users."));
            privList.add(new MCRPrivilege("create group", "Users with this privilege may create new groups."));
            privList.add(new MCRPrivilege("delete user", "Users with this privilege may delete other users."));
            privList.add(new MCRPrivilege("delete group", "Users with this privilege may delete groups."));
            privList.add(new MCRPrivilege("modify user", "Users with this privilege may modify data of other users."));
            privList.add(new MCRPrivilege("modify group", "Users with this privilege may modify data of groups."));
            privList.add(new MCRPrivilege("modify privileges", "Users with this privilege may modify data of privileges."));
            privList.add(new MCRPrivilege("user administrator", "Users with this privilege have administrator rights in the system."));
            privList.add(new MCRPrivilege("list all users", "Users with this privilege may list the users of the system."));
            privList.add(new MCRPrivilege("list all privileges", "Users with this privilege may list the privileges of the system."));
            privList.add(new MCRPrivilege("change owner of object", "Users with this privilege may change the owner of an object in the repository."));
        ...
        try {
            ...
            MCRGroup g = new MCRGroup(sgroup, suser, null, null, "The superuser group", admUserIDs, admGroupIDs, mbrUserIDs, mbrGroupIDs, groupIDs, privileges);
        ...
        try {
            ...
            MCRGroup g = new MCRGroup(ggroup, suser, null, null, "The guest group", admUserIDs, admGroupIDs, mbrUserIDs, mbrGroupIDs, groupIDs, privileges);
     ...
     */
    public static void saveAllPrivilegesToFile(String filename) throws MCRException {
        try {
    ...
    public static final void addPrivilegeToGroup(String groupID, String priv) {
        try {
            ...
            throw new MCRException("Error while adding privilege " + priv + " to group " + groupID + ".", e);
        }
    }
     ...
     *            the privilege String
     */
    public static final void removePrivilegeFromGroup(String groupID, String priv) {
        try {
            MCRGroup group = MCRUserMgr.instance().retrieveGroup(groupID);
     ...
     */
    public static final void updatePrivilegesFromFile(String filename) throws MCRException {
        if (!checkFilename(filename)) {
            return;
        }
