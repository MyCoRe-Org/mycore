...
public class MCRUserCommands extends MCRAbstractCommands
{
  ...
  public MCRUserCommands()
  {
    ...
    com = new MCRCommand("init superuser",
    ...
    com = new MCRCommand("update privileges data from file {0}",
    ...
    com = new MCRCommand("create group data from file {0}",
    ...
    com = new MCRCommand("import group data from file {0}",
    ...
    com = new MCRCommand("update group data from file {0}",
   ...
   **/
  public static final void encryptPasswordsInXMLFile(String oldFile, String newFile)
  throws MCRException
  {
   ...
   **/
  private static final void createUserFromFile(String filename, boolean useEncryption)
  throws MCRException
  {
   ...
   * @param useEncryption flag to determine whether we use password encryption or not
   **/
  private static final void updateUserFromFile(String filename, boolean useEncryption)
  throws MCRException
  {
    if (!checkFilename(filename))
      return;
   ...
   * @throws MCRException
   */
  public static final void addMemberGroupToGroup(
   ...
   * @throws MCRException
   */
  public static final void removeMemberGroupFromGroup(
    String mbrGroupID, String groupID) throws MCRException
  {
    try {
     MCRGroup group = MCRUserMgr.instance().retrieveGroup(groupID);
   ...
   **/
  public static final void addPrivilegeToGroup(
   ...
   * @param priv the privilege String
   **/
  public static final void removePrivilegeFromGroup(
    String groupID, String priv)
    {
    try {
      MCRGroup group = MCRUserMgr.instance().retrieveGroup(groupID);
   ...
   * @throws MCRException
   */
  public static final void addMemberUserToGroup(
   ...
   * @throws MCRException
   */
  public static final void removeMemberUserFromGroup(
    String mbrUserID, String groupID) throws MCRException
  {
    try {
     MCRGroup group = MCRUserMgr.instance().retrieveGroup(groupID);
