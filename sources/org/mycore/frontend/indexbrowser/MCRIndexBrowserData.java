...
public class MCRIndexBrowserData {
  ...
  private void setListeElm(Element child, String[] Fields, int startindex, String[] listelm, boolean append) {
    ...
    for (int j = 0; j < Fields.length; j++) {
      ...
      /*
       * mcrHit - <mcrhit id="docportal_author_000000000441"> ... </mcrhit>
       */

      // * �ber die ID die darzustellenden Daten holen
  ...
  private void buildQuery() {
    ...
    /**
     * <mcrresults sorted="true"> <mcrhit
     * mcrid="atlibri_professorum_000000000441"> <sortData> <data
     * name="title">Aepinus</data> </sortData> </mcrhit> <mcrhit
     * mcrid="atlibri_document_000000000001"> <sortData> <data
     * name="title">Haupttitel</data> </sortData> </mcrhit> <mcrhit
     * mcrid="atlibri_document_000000000002"> <sortData> <data
     * name="title">Artikel Test Editor Servlet</data> </sortData> </mcrhit>
     * ...
     */
  ...
  private int fillmyLinkedList() {
    ...
    /**
     * <mcrresults sorted="true"> <mcrhit id="atlibri_document_000000000002">
     * <sortData> <data name="title">Artikel Test Editor Servlet</data>
     * </sortData> </mcrhit> ...
     */
    if (mcrHit != null) {
      int numRows = mcrHit.size();

      // List elemente[sortfield,browsefield,extrafields1, extrafield2, ...
      // extrafieldn]
