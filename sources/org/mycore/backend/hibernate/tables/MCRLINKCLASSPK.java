...
public class MCRLINKCLASSPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		return new EqualsBuilder().append(this.getMcrfrom(),
				castother.getMcrfrom()).append(this.getMcrto(),
				castother.getMcrto()).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getMcrfrom()).append(getMcrto())
				.toHashCode();
	}
}
