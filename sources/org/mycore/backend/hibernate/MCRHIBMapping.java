...
public class MCRHIBMapping {
    ...
    public void generateTables(Configuration cfg){
        try{
		    ...
		    // derivate
		    map = new MCRTableGenerator( "MCRXMLDER", "src.tables.MCRXMLType", "", 2);
		    ...
		    // Category
		    map = null;
		    map = new MCRTableGenerator("MCRCATEG", "src.tables.MCRCATEG","", 2);
		    ...
		    // Categorylabel
		    map = null;
		    map = new MCRTableGenerator("MCRCATEGLABEL", "src.tables.MCRCATEGLABEL", "", 3);
		    map.addIDColumn("id", "ID", dbString, 128, "assigned");
		    map.addIDColumn("clid", "CLID", dbString, 64, "assigned");
		    ...
		    // Classification
		    map = null;
		    map = new MCRTableGenerator("MCRCLASS", "src.tables.MCRCLASS", "", 1);
		    map.addIDColumn("id","ID", dbString, 64, "assigned");
		    cfg.addXML(map.getTableXML());
		    
		    // Classification Label
		    map = null;
		    map = new MCRTableGenerator("MCRCLASSLABEL", "src.tables.MCRCLASSLABEL", "", 2);
		    map.addIDColumn("id","ID", dbString, 64, "assigned");
		    map.addIDColumn("lang","LANG", dbString, 8, "assigned");
		    ...
		    // FS Nodes
		    map = null;
		    map = new MCRTableGenerator("MCRFSNODES", "src.tables.MCRFSNODES", "", 1);
		    ...
		    // Group Admins
		    map = null;
		    map = new MCRTableGenerator("MCRGROUPADMINS", "src.tables.MCRGROUPADMINS", "", 1);
		    ...
		    // Group Members
		    map = null;
		    map = new MCRTableGenerator("MCRGROUPMEMBERS", "src.tables.MCRGROUPMEMBERS", "", 1);
		    map.addIDColumn("id", "ID", dbInt, 0, "assigned");
		    map.addColumn("gid", "GID", dbString, 20, true, false);
		    map.addColumn("userid", "USERID", dbString, 20, true, false);
		    map.addColumn("groupid", "GROUPID", dbString, 20, true, false);
		    ...
		    // Group Members
		    map = null;
		    map = new MCRTableGenerator("MCRGROUPS", "src.tables.MCRGROUPS", "", 1);
		    ...
		    // Link Class
		    map = null;
		    map = new MCRTableGenerator("MCRLINKCLASS", "src.tables.MCRLINKCLASS", "", 2);
		    ...
		    // Link Class
		    map = null;
		    map = new MCRTableGenerator("MCRLINKHREF", "src.tables.MCRLINKHREF", "", 2);
		    map.addIDColumn("mcrfrom", "MCRFROM", dbString, 64, "assigned");
		    map.addIDColumn("mcrto", "MCRTO", dbString, 194, "assigned");
		    cfg.addXML(map.getTableXML());
		    ...
		    // Privileges
		    map = null;
		    map = new MCRTableGenerator("MCRPRIVS", "src.tables.MCRPRIVS", "", 1);
		    ...
		    // Privileges
		    map = null;
		    map = new MCRTableGenerator("MCRPRIVSLOOKUP", "src.tables.MCRPRIVSLOOKUP", "", 1);
		    map.addIDColumn("gid", "GID", dbString, 20, "assigned");
		    ...
		    // User
		    map = null;
		    map = new MCRTableGenerator("MCRUSERS", "src.tables.MCRUSERS", "", 2);
