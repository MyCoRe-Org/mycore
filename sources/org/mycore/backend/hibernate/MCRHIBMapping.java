	...
	public void generateTables(Configuration cfg) {
		try {
			...
			map = new MCRTableGenerator(config
					.getString("MCR.classifications_store_sql_table_categ"),
					"org.mycore.backend.hibernate.tables.MCRCATEG", "", 2);
			...
			// Categorylabel
			map = new MCRTableGenerator(
					config
							.getString("MCR.classifications_store_sql_table_categlabel"),
					"org.mycore.backend.hibernate.tables.MCRCATEGLABEL", "", 3);
			...
			// Classification
			map = new MCRTableGenerator(config
					.getString("MCR.classifications_store_sql_table_class"),
					"org.mycore.backend.hibernate.tables.MCRCLASS", "", 1);
			...
			map = new MCRTableGenerator(
					config
							.getString("MCR.classifications_store_sql_table_classlabel"),
					"org.mycore.backend.hibernate.tables.MCRCLASSLABEL", "", 2);
			...
			// CStore
			map = new MCRTableGenerator("MCRCSTORE",
					"org.mycore.backend.hibernate.tables.MCRCSTORE", "", 1);
			map.addIDColumn("storageid", "STORAGEID", dbString, 64, "assigned",
					true);
			...
			// FS Nodes
			map = new MCRTableGenerator(config
					.getString("MCR.IFS.FileMetadataStore.SQL.TableName"),
					"org.mycore.backend.hibernate.tables.MCRFSNODES", "", 1);
			...
			map.addColumn("storeid", "STOREID", dbString, 32, false, false,
					false);
			map.addColumn("storageid", "STORAGEID", dbString, 250, false,
					false, false);
			...
			// Group Admins
			map = new MCRTableGenerator(config
					.getString("MCR.users_store_sql_table_group_admins"),
					"org.mycore.backend.hibernate.tables.MCRGROUPADMINS", "", 3);
			map.addIDColumn("gid", "GID", dbString, 20, "native", false);
			map.addIDColumn("userid", "USERID", dbString, 20, "native", false);
			map
					.addIDColumn("groupid", "GROUPID", dbString, 20, "native",
							false);
			cfg.addXML(map.getTableXML());

			// Group Members
			map = new MCRTableGenerator(config
					.getString("MCR.users_store_sql_table_group_members"),
					"org.mycore.backend.hibernate.tables.MCRGROUPMEMBERS", "",
					3);
			map.addIDColumn("gid", "GID", dbString, 20, "native", false);
			map.addIDColumn("userid", "USERID", dbString, 20, "native", false);
			map
			...
			// Group
			map = new MCRTableGenerator(config
					.getString("MCR.users_store_sql_table_groups"),
					"org.mycore.backend.hibernate.tables.MCRGROUPS", "", 1);
			map.addIDColumn("gid", "GID", dbString, 20, "assigned", false);
			map.addColumn("creator", "CREATOR", dbString, 20, true, false,
					false);
			map.addColumn("creationdate", "CREATIONDATE", dbTimestamp, 0, true,
					false, false);
			map.addColumn("modifieddate", "MODIFIEDDATE", dbTimestamp, 0, true,
					false, false);
			map.addColumn("description", "DESCRIPTION", dbString, 200, true,
					false, false);
			cfg.addXML(map.getTableXML());

			// Link Class
			map = new MCRTableGenerator(config
					.getString("MCR.linktable_store_sql_table_class"),
					"org.mycore.backend.hibernate.tables.MCRLINKCLASS", "", 2);
			...
			// Link Href
			map = new MCRTableGenerator(config
					.getString("MCR.linktable_store_sql_table_href"),
					"org.mycore.backend.hibernate.tables.MCRLINKHREF", "", 2);
			map.addIDColumn("mcrfrom", "MCRFROM", dbString, 64, "assigned",
					false);
			map.addIDColumn("mcrto", "MCRTO", dbString, 194, "assigned", false);
			cfg.addXML(map.getTableXML());
			...
			// Privileges
			map = new MCRTableGenerator(config
					.getString("MCR.users_store_sql_table_privileges"),
					"org.mycore.backend.hibernate.tables.MCRPRIVSM", "", 1);
			map.addIDColumn("name", "NAME", dbString, 100, "assigned", false);
			map.addColumn("description", "DESCRIPTION", dbString, 200, false,
					false, false);
			cfg.addXML(map.getTableXML());

			// Privilegeslookup
			map = new MCRTableGenerator(config
					.getString("MCR.users_store_sql_table_privs_lookup"),
					"org.mycore.backend.hibernate.tables.MCRPRIVSLOOKUP", "", 2);
			map.addIDColumn("gid", "GID", dbString, 20, "assigned", false);
			map.addIDColumn("name", "NAME", dbString, 200, "assigned", false);
			cfg.addXML(map.getTableXML());

			// NBN Manager
			if (!config.getString("MCR.NBN.PersistenceStore.TableName", "")
					.equals("")) {
				map = new MCRTableGenerator(config
						.getString("MCR.NBN.PersistenceStore.TableName"),
						"org.mycore.backend.hibernate.tables.MCRNBNS", "", 1);
				map
						.addIDColumn("niss", "NISS", dbString, 32, "assigned",
								false);
				...
				map.addColumn("date", "DATE", dbTimestamp, 32, true, false,
						false);
				map.addColumn("documentid", "DOCUMENTID", dbString, 64, false,
						false, false);
				cfg.addXML(map.getTableXML());
			}
			...
			// User
			map = new MCRTableGenerator(config
					.getString("MCR.users_store_sql_table_users"),
					"org.mycore.backend.hibernate.tables.MCRUSERS", "", 2);
			map.addIDColumn("numid", "NUMID", dbInt, 0, "assigned", false);
			map.addIDColumn("uid", "UID", dbString, 20, "assigned", false);
			map.addColumn("creator", "CREATOR", dbString, 20, true, false,
					false);
			map.addColumn("creationdate", "CREATIONDATE", dbTimestamp, 0,
					false, false, false);
			map.addColumn("modifieddate", "MODIFIEDDATE", dbTimestamp, 0,
					false, false, false);
			map.addColumn("description", "DESCRIPTION", dbString, 200, false,
					false, false);
			map
					.addColumn("passwd", "PASSWD", dbString, 128, true, false,
							false);
			map
					.addColumn("enabled", "ENABLED", dbString, 8, true, false,
							false);
			map.addColumn("upd", "UPD", dbString, 8, true, false, false);
			map.addColumn("salutation", "SALUTATION", dbString, 24, false,
					false, false);
			...
			// ID Table
			map = new MCRTableGenerator("MCRID",
					"org.mycore.backend.hibernate.tables.MCRID", "", 1);
			...
			throw new IllegalStateException(
					"couldn't create hibernate mappings");
		}
	}
}
