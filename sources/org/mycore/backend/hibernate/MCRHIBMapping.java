...
public class MCRHIBMapping {
	...
	try {
	    ...
	    map.addColumn("owner", "OWNER", dbString, 64, true, false);
	    map.addColumn("name", "NAME", dbString, 250, true, false);
	    map.addColumn("label", "LABEL", dbString, 250, false, true);
	    map.addColumn("size", "SIZE", dbLong, 0, true, false);
	    map.addColumn("date", "DATE", dbTimestamp, 0, false, false);
	    map.addColumn("storeid", "STOREID", dbString, 32, false, false);
	    map.addColumn("storageid", "STORAGEID", dbString, 250, false, false);
	    map.addColumn("fctid", "FCTID", dbString, 32, false, false);
	    map.addColumn("md5", "MD5", dbString, 32, false, false);
	    map.addColumn("numchdd", "NUMCHDD", dbInt, 0, false, false);
	    map.addColumn("numchdf","NUMCHDF", dbInt, 0, false, false);
	    map.addColumn("numchtd", "NUMCHTD", dbInt, 0, false, false);
	    map.addColumn("numchtf", "NUMCHTF", dbInt, 0, false, false);
	    cfg.addXML(map.getTableXML());
