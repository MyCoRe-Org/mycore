...
/**
 * This class implements a pool of connections to XML:DB Other classes get a
 * connection from the pool when they need one and release the connection after
 * their work has finished.
 * 
...
public class MCRXMLDBConnectionPool {
    ...
    protected MCRXMLDBConnectionPool() throws MCRPersistenceException {
        ...
        LOGGER.debug("MCRXMLDBConnectionPool MCR.persistence_xmldb_database_url: " + CONNECTION_STRING);
        USER = config.getString(CONF_PREFIX + "user", null);
        LOGGER.debug("MCRXMLDBConnectionPool MCR.persistence_xmldb_user      : " + USER);
     ...
     */
    protected Collection buildConnection(String collection) throws XMLDBException {
     ...
     */
    public Collection getConnection(String collection) throws MCRPersistenceException {
