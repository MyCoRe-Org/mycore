...
public final class MCRXMLDBPersistence 
    ...
    /**
	 * This method creates and stores the data from MCRTypedContent and XML data
	 * in the XMLDB datastore.
	 * 
	 * @param mcr_tc
	 *            the typed contend of all searchable data
	 * @param doc
	 *            the XML document as DOM tree
	 * @param mct_ts
	 *            the string for the text search
...
/**
 * The methode create a new datastore based of given configuration. It create a
 * new data table for storing MCRObjects with the same MCRObjectID type.
 * 
 * @param mcr_type
...
public void createDataBase(String mcr_type, org.jdom.Document mcr_conf)
  ...
  logger.info("This feature exist not for this store.");
    ...
    /**
	 * Updates the content in the database. Currently the same as delete and
	 * then a new create. Should be made with XUpdate in the future.
	 * 
	 * @param mcr_tc
	 *            the typed contend of all searchable data
	 * @param doc
