...
public class MCRLuceneSearcher extends MCRSearcher {
    ...
    /**
     * a single thread for every <code>indexDir</code> that performs all write operations.
     *  
     * @author Thomas Scheffler (yagee)
     */
    private static class IndexModifierThread implements Runnable {
        private Queue queue;
     ...
     * 
     * TODO: should be replaced by java.util.concurrent.ConcurrentLinkedQueue<E> if we switch to J2SE > 5
     * @author Thomas Scheffler (yagee)
     */
