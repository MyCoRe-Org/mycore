...
public final class MCRLUCENESearchStore implements MCRObjectSearchStoreInterface {
    ...
    public final void create(MCRBase obj) throws MCRPersistenceException {
        ...
        try {
            ...
            throw new MCRPersistenceException("Error Creating search entry in lucene " + ex.getMessage(), ex);
        }
    }
     ...
     * 
     */
    private Document buildLuceneDocument(String key, List fields, String typeId) throws Exception {
    ...
    private void deleteLuceneDocument(String id, String type) throws Exception {
        ...
        if (1 == hits.length()) {
            logger.info(" id: " + hits.id(0) + " score: " + hits.score(0) + " key: " + hits.doc(0).get("mcr_ID"));
