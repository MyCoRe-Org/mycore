 ...
 * 
 * It is assumed that a Tamino database has been created and is running. It is
 * assumed that tamino database uri was given in Mycore property file.
 * 
 * The following tasks are to be preformed: - Get TaminoDATABASE_URI from Mycore
 * property file - Obtain the connection factory - Obtain the connection to the
 * database - Obtain a SchemaAccessor - Clean collection "derivate" - Clean
 * collection "document" - Clean collection "legalentity" - Clean collection
 * "ino:etc" - Close the connection
 * 
 * @author: lili tan
 * @version 1.0 $ $Date$
 * 
