...
/**
 * This class insert tamino schema files into tamino database. It is to be
 * called by MCRTaminoManager.java.
 * 
 * It is assumed that a Tamino database has been created and is running. The
 * tamino database uri was defined in Mycore property file.
 * 
 * The following tasks are to be preformed: - Obtain the connection factory -
 * Obtain the connection to the database - Instantiate an empty TXMLObject
 * instance using the JDOM object model - Read Tamino Schema from a file and
 * construct a TXMLObject - Obtain a SchemaAccessor - Define a new collection
 * and insert a schema in database - Print the tamino schema to stdout and its
...
public class MCRTaminoSchema {
    ...
    String SchemaFile) throws TException {
        ...
        TXMLObject schemaXmlObject = TXMLObject.newInstance(TJDOMObjectModel
                .getInstance());

        try {

            System.out
                    .println("Reading TSD schema from file and insert into database");
            ...
            TSchemaDefinition3Accessor TSD3Accessor = connection
                    .newSchemaDefinition3Accessor(TJDOMObjectModel
                            .getInstance());
