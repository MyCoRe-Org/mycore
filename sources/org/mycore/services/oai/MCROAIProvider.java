...
public class MCROAIProvider extends MCRServlet {
    ...
    // If there are other metadata formats than the standard format oai_dc available, 
    ...
    private org.jdom.Document identify(HttpServletRequest request,
        ...
        eIdentify
                .addContent(newElementWithContent("adminEmail", ns, oaiAdminEmail));
    ...
    private org.jdom.Document listMetadataFormats(HttpServletRequest request,
        ...
        try {
            ...
            logger.fatal("Missing configuration item: "
                    + STR_OAI_QUERYSERVICE + " is missing.");
            return null;
        }
                    ...
                    if (result != null) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if ((maxReturns == 0)
                                ...
                                String[] array = getHeader(object, objectId, repositoryID,
                                       instance);           
    ...
    public static String[] getHeader(MCRObject object, String objectId,
        ...
        // Format the date.
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:dd'Z'");
