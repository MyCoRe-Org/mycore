...
public interface MCRNBNManager {
    /**
     * Reserves a NBN for later use. In a later step, that NBN can be assigned
     * to a document.
     * 
     * @param urn
    ...
    /**
     * Sets the URL for the NBN URN given. This is the URL that the NBN points
     * to. The NBN has to be already reserved.
     * 
     * @param urn
    ...
    /**
     * Gets the URL for the NBN URN given. This is the URL that the NBN points
     * to. If there is no URL for this NBN, the method returns null.
     * 
     * @param urn
    ...
    /**
     * Returns all URNs that match the given pattern. The pattern may be null to
     * select all stored URNs, or may be a pattern containing '*' or '?'
     * wildcard characters.
     * 
     * @param pattern
     ...
     * 
     * @param urn
     *            the urn to get the document id for
