...
/**
 * This class is the result list of a XQuery question to the persistence system
 * or remote systems. the result ist transparent over all searched instances of
 * a common instance collection or of a local instance. The method use,
 * depending of the persitence type property, a interface to a query transformer
 * form XQuery to the target system query language.
 * 
