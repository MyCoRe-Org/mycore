...
public class MCRMetadata2Fields {
	...
	private static final Logger LOGGER = Logger
			.getLogger(MCRMetadata2Fields.class);
	 ...
	 */
	public static List buildFields(MCRFile file) throws IOException,
			JDOMException {
	 ...
	 */
	private static synchronized Document buildStylesheet(String type,
			Element definition) {
		...
		if (xsl == null) {
			...
			if (LOGGER.isDebugEnabled()) {
				LOGGER
						.debug("---------- stylesheet to build search fields ---------");
				XMLOutputter out = new XMLOutputter(org.jdom.output.Format
						.getPrettyFormat());
	...
	public static void main(String[] args) throws Exception {
		Document xml = new SAXBuilder()
				.build(new File("c:\\demo-document.xml"));
