 ...
 *
 * <P>
 * Permissions are attached to principals
 * and define the collection of rights 
 * to access a certain object.
 
 * <P>
 * A permission can be granted or denied.
 * A denied permission is similar to a missing permission,
 * but algorithms which check access to resources may come
 * to a (negative) decision earlier when a permission
...
//------------------------------------------------------------------------------
   ...
   * @param  grant      if <code>true</code> permission is granted, denied otherwise.
   */
...
//------------------------------------------------------------------------------
  ...
  /**
   * Checks if the given permission contained in this set of permissions
   * is granted.
   *
   * @param   permission  the permission to be checked.
   *
...
//------------------------------------------------------------------------------
  ...
  /**
   * Creates a copy of this set of permissions. Sometimes principals
   * have the same set of permissions. While single permissions may be
   * shared this is not true for sets of permissions, because they are mutable. 
   *
...
//------------------------------------------------------------------------------
   ...
   *
   * @param permissionRing the ring to be added.
   */
