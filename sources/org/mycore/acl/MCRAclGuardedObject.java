 ...
 * @see MCRAclGuarded
 */
public class MCRAclGuardedObject implements MCROwnedObject, MCRPermissionContext, MCRAclGuarded {
    // /============================================================================/
     ...
     *             if the currentUser is not allowed to set a new owner.
     */
    public final void changeOwnerGroup(MCRGroup newOwnerGroup) throws MCRAccessException {
     ...
     */
    public final void checkAccess(MCRPermission permission) throws MCRAccessException {
        MCRUser currentUser = MCRUserMgr.instance().getCurrentUser();
        ...
        if (!acl.isAccessPermitted(currentUser, this, permission)) {
            throw new MCRAccessException(MCRAclMessages.ACCESS_MESSAGE + MCRAclMessages.userMessage(currentUser) + MCRAclMessages.permissionMessage(permission));
        }
    }
