...
import org.mycore.backend.cm7.*;
import java.util.*;
import java.io.*;

/**
 * This class implements the MCROldContentStore interface to store the content of
 * MCROldFile objects in a IBM Content Manager 7 index class. The index class, the
 ...
 */
public class MCROldCStoreContentManager7 implements MCROldContentStore
{ 
  ...
  /** The name of the keyfield that stores the MCROldFile.getOwnerID() */
  protected String keyfieldOwner;
  
  /** The name of the keyfield that stores the MCROldFile.getPath() */
  ...
  /** 
   * Creates a new MCROldCStoreContentManager7 instance. This instance has to 
   * be initialized by calling init() before it can be used.
   */
  public MCROldCStoreContentManager7()
  {}
