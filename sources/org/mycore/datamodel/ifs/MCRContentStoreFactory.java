...
public class MCRContentStoreFactory {
	...
	private static final Logger LOGGER = Logger
			.getLogger(MCRContentStoreFactory.class);
	...
	public static MCRContentStore getStore(String storeID) {
		...
		if (!STORES.containsKey(storeID)) {
			try {
				String storeClass = "MCR.IFS.ContentStore." + storeID
						+ ".Class";
				LOGGER.debug("getting StoreClass: " + storeClass);
				Object obj = MCRConfiguration.instance().getInstanceOf(
						storeClass);
				...
				String msg = "Could not load MCRContentStore with store ID = "
						+ storeID;
