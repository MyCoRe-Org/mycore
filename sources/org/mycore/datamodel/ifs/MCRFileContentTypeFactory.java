 ...
 * detect the file content type by providing file content header and
 * filename.
 *
 * The list of known file content types is defined in an XML file that 
 * is specified in the property 
 * <code>MCR.IFS.FileContentTypes.DefinitionFile</code>, 
 * and that file is searched in the CLASSPATH directories or JAR files.
 *
 * The class that implements the file content type detector must be 
...
public class MCRFileContentTypeFactory
{
   ...
   * @param header the first bytes of the file header, may be null or empty
   * @return the file content type detected, or the default file content type if detection was not possible
   */  
