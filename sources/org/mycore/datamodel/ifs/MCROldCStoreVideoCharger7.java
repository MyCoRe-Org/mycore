 ...
 * MCROldFile objects in IBM VideoCharger Server. This allows the content to be 
...
{ 
  ...
  /** 
   * Creates a new MCROldCStoreVideoCharger7 instance. This instance has to 
   * be initialized by calling init() before it can be used.
   */
  public MCROldCStoreVideoCharger7()
  {
    ...
    throws MCRPersistenceException, IOException
  {
    ...
    for( int i = 0; i < list.length; i++ )
    {
      ...
      MCROldFile remote = new MCROldFile();
   ...
   *
   * @param file the MCROldFile to build an ID for
   */
  protected synchronized String buildNextStorageID( MCROldFile file )
  {
    String ID = null;
    do
    { 
