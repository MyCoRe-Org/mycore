...
public class MCRDirectory extends MCRFilesystemNode
{
  ...
  /**
   * Creates a new, empty root MCRDirectory with the given name,
   * belonging to the given ownerID. The directory is assumed to be
   * a standalone "root directory" that has no parent. 
   *
   * @param name the name of the new MCRDirectory
  ...
  /**
   * Creates a new, empty MCRDirectory with the given name
   ...
   *
   * @param ID the unique ID of the MCRDirectory to return
  ...
  /**
   * Returns the root MCRDirectory that has no parent and
   * is logically owned by the object with the given ID.
   *
   * @param ownerID the ID of the logical owner of that directory
   ...
   *
   * @param child the child to be removed from this directory
   **/
  ...
  /**
   * Returns all direct child nodes in this directory, sorted 
   * by the given Comparator implementation. You may use one of
   * the Comparators defined as static constants in this class,
   * or build your own Comparator.
   *
   * @param sortOrder the Comparator to be used to sort the children
   * @return a possibly empty array of MCRFilesystemNode objects
   **/
  ...
  /**
   * Returns true, if this directory contains a direct child with
   * the given filename.
   *
  ...
  /**
   * Returns the direct child of this directory at the
   * given position in the natural order of the children
   *
   * @param the index of the child in the list of children
   **/  
  ...
  /**
   * Returns the child node with the given filename. This method
   * also accepts the aliases "." for the current directory 
  ...
  /**
   * Returns the node that is addressed by the given 
   * absolute or relative path. If an absolute path
   * starting with a slash "/" is given, the node will be
   * located relative to the root directory of this directory.
   * If a relative path is given, the path may contain 
   * the aliases "." for the current directory 
   * or ".." for the parent directory, and the node will be
   * located relative to this directory.
   *
   * @param path the absolute path (starting with a "/") or path relative to this directory, possibly containing "." or ".." aliases
  ...
  /**
   * Returns true if this directory is not empty and therefore
   * contains any subdirectories or files.
   **/
  ...
  /** 
   * Returns the number of child nodes in this directory. The 
   * additional parameters control what type of nodes 
   * will be counted and if only direct children or all children
   * will be counted.
   *
   * @param nodetype one of the constants FILES, DIRECTORIES, or NODES for both types
   * @param where either HERE to only count direct children, or TOTAL to count also indirect children
   **/
  ...
  /**
   * Internal method that is called when the size of a child node
   * has changed, to update the total size of the parent directory.
   **/
  ...
  /**
   * Updates the date of last modification to the current date and
  ...
  /** 
   * Creates a list of all MD5 checksums of all files 
   * that are direct or indirect children of this directory
   * and adds them to the given list object. 
   **/
  ...
  /**
   * Builds a fingerprint of all file's contents of this 
   * directory, by collecting the MD5 checksums of all direct
   * or indirect child files of this directory, sorting them
   * to ascending order and writing this list line by line as
   * UTF-8 encoded bytes. This method can be used to digitally
