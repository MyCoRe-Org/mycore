...
public abstract class MCRAudioVideoExtender {
     ...
     */
    public String getDurationFormatted(String hourLabel, String minutesLabel,
            String secondsLabel) {
     ...
     */
    public abstract void getPlayerStarterTo(OutputStream out, String startPos,
    ...
    public String toString() {
        ...
        sb.append("Bitrate         : ").append(getBitRateFormatted()).append(
                "/sec.");
        sb.append(" (").append(getBitRate()).append(")\n");

        if (isVideo()) {
            sb.append("Framerate       : ").append(getFrameRateFormatted())
                    .append(" fps");
            sb.append(" (").append(getFrameRate()).append(")\n");
        }

        sb.append("Duration        : ").append(
                getDurationFormatted("h", "min", "sec"));
     ...
     */
    protected String getBetween(String prefix, String suffix, String data,
            String defaultValue) {
    ...
    protected URLConnection getConnection(String url)
        ...
        try {
            ...
            String msg = "Could not get connection to Audio/Video Store URL: "
                    + url;
    ...
    protected String getMetadata(String url) throws MCRPersistenceException {
        try {
            ...
            String msg = "Could not get metadata from Audio/Video Store URL: "
                    + url;
            throw new MCRPersistenceException(msg, exc);
        }
    }
