...
public class MCRMetaLangText extends MCRMetaDefault implements MCRMetaInterface {
    ...
    public MCRMetaLangText(String set_datapart, String set_subtag,
            ...
            String set_form, String set_text) throws MCRException {
    ...
    public org.jdom.Element createXML() throws MCRException {
        if (!isValid()) {
            ...
            throw new MCRException(
                    "The content of MCRMetaLangText is not valid.");
        }
     ...
     */
    public Object clone() {
        MCRMetaLangText out = new MCRMetaLangText(datapart, subtag, lang, type,
                inherited, form, text);
        return (Object) out;
    }
