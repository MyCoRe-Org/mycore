...
public class MCRTypedContent {
     ...
     */
    public final boolean addElement(int intype, String inname, int informat, Object invalue) {
     ...
     * @return false if an error was occured, else return true
     */
    public final boolean addDateElement(int intype, String inname, GregorianCalendar invalue) {
        if (invalue == null) {
            return false;
        }
     ...
     * @return false if an error was occured, else return true
     */
    public final boolean addStringElement(int intype, String inname, String invalue) {
    ...
    public final MCRTypedContent getElements(int from, int to) {
        ...
        for (int i = from; i < (to + 1); i++) {
            out.addElement(getTypeElement(i), getNameElement(i), getFormatElement(i), getValueElement(i));
        }
    ...
    public final void debug() {
        ...
        for (int i = 0; i < type.size(); i++) {
            System.out.println(i + "  " + type.get(i) + "   " + name.get(i) + "   " + format.get(i) + "   " + value.get(i));
        }
