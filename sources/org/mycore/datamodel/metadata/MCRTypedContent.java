 ...
 * in the persistence layer. With this interface the persistence layer
 * can read all data for create or update a search data tree like store as
...
public final boolean isMasterTag(int index)
  ...
  if (((Integer)type.get(index)).intValue() == TYPE_MASTERTAG) { return true; }
  return false;
  }
...
public final boolean isTag(int index)
  {
  if ((index<0) || (index>type.size())) { return false; }
  if (((Integer)type.get(index)).intValue() == TYPE_TAG) { return true; }
  return false;
  }
...
public final boolean isSubTag(int index)
  {
  if ((index<0) || (index>type.size())) { return false; }
  if (((Integer)type.get(index)).intValue() == TYPE_SUBTAG) { return true; }
  return false;
  }
...
public final boolean isSub2Tag(int index)
  {
  if ((index<0) || (index>type.size())) { return false; }
  if (((Integer)type.get(index)).intValue() == TYPE_SUB2TAG) { return true; }
  return false;
  }
...
public final boolean isValue(int index)
  {
  if ((index<0) || (index>type.size())) { return false; }
  if (((Integer)type.get(index)).intValue() == TYPE_VALUE) { return true; }
  return false;
  }
...
public final boolean isAttribute(int index)
  {
  if ((index<0) || (index>type.size())) { return false; }
  if (((Integer)type.get(index)).intValue() == TYPE_ATTRIBUTE) { return true; }
  return false;
  }
...
public final int getTypeElement(int index)
  {
  if ((index<0) || (index>type.size())) { return TYPE_UNDEFINED; }
...
public final MCRTypedContent getElements(int from, int to)
  ...
  if ((from<0) || (from>type.size())) { return null; }
  if ((to<0) || (to>type.size())) { return null; }
