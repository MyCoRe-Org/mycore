...
public static synchronized MCRLinkTableManager instance()
  {
  if( singleton == null ) singleton = new MCRLinkTableManager();
  return singleton;
  }
 ...
 * @param to   the target of the reference as MCRObjectID
 **/
public void addReferenceLink(String type, MCRObjectID from,
  MCRObjectID to)
 ...
 *
 * @param type the table type
 * @param from the source of the reference as String
 * @param to   the target of the reference as String
 **/
public void addReferenceLink(String type, String from, String to)
  ...
  logger.debug("Link in table "+type+" add for "+from+"<-->"+to);
  try {
...
/**
 * The method add a classification link pair for the given type to the store.
 *
 * @param from the source of the reference as MCRObjectID
 * @param classid the target classification id as MCRObjectID
 * @param categid the target category id ad String
 **/
 ...
 *
 * @param from the source of the reference as String
 * @param classid the target classification id as String
 * @param categid the target category id ad String
 **/
...
/**
 * The method delete a classification link pair for the given type to the store.
 *
 * @param from the source of the reference as MCRObjectID
 **/
