 ...
 */
final public class MCRMetaBoolean extends MCRMetaDefault implements
        MCRMetaInterface {
    ...
    public MCRMetaBoolean(String set_datapart, String set_subtag,
            ...
            String set_value) throws MCRException {
    ...
    public MCRMetaBoolean(String set_datapart, String set_subtag,
            String default_lang, String set_type, int set_inherted,
            boolean set_value) throws MCRException {
        super(set_datapart, set_subtag, "en", set_type, set_inherted);
        value = set_value;
    }
    ...
    public final org.jdom.Element createXML() throws MCRException {
        if (!isValid()) {
            throw new MCRException(
                    "The content of MCRMetaBoolean is not valid.");
        }
    ...
    public final Object clone() {
        MCRMetaBoolean out = new MCRMetaBoolean(datapart, subtag, lang, type,
                inherited, value);
        return (Object) out;
    }
