...
public class MCRObjectService {
    ...
    public MCRObjectService() {
        ...
        dates = new ArrayList();
        MCRMetaDate d = new MCRMetaDate("service", "servdate", lang,
                "createdate", 0, new GregorianCalendar());
        dates.add(d);
        d = new MCRMetaDate("service", "servdate", lang, "modifydate", 0,
    ...
    public final void setFromDOM(org.jdom.Element service_element) {
        ...
        if (dates_element != null) {
            ...
            for (int i = 0; i < date_len; i++) {
                org.jdom.Element date_element = (org.jdom.Element) date_element_list
                        .get(i);
                ...
                for (int j = 0; j < dates.size(); j++) {
                    if (((MCRMetaDate) dates.get(j)).getType().equals(
                            date.getType())) {
                        k = j;
                        break;
                    }
        ...
        if (flags_element != null) {
            ...
            for (int i = 0; i < flag_len; i++) {
                org.jdom.Element flag_element = (org.jdom.Element) flag_element_list
                        .get(i);
    ...
    public final void addFlag(String value) {
        ...
        MCRMetaLangText flag = new MCRMetaLangText("service", "servflag", null,
                null, 0, null, value);
        flags.add(flag);
    }
