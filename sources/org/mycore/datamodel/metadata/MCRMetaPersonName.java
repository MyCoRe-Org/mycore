...
/**
 * This class implements all methods for handling with the MCRMetaPersonName part
 * of a metadata object. The MCRMetaPersonName class represents a natural person
...
public MCRMetaPersonName(String set_datapart, String set_subtag, 
  ...
  peerage   = "";
  prefix = "";
  set(set_firstname,set_callname,set_surname,set_fullname,set_academic,
    set_peerage,set_prefix);
  }
...
public final void set(String set_firstname, String set_callname, String 
  set_surname, String set_fullname, String set_academic, String set_peerage,
  String set_prefix)
  {
 ...
 * by the MyCoRe XML MCRMetaPersonName definition for the given subtag.
 *
...
public final org.jdom.Element createXML() throws MCRException
  ...
  if (!isValid()) {
    debug();
    throw new MCRException("The content of MCRMetaPersonName is not valid."); }
...
public final String createTextSearch(boolean textsearch)
  ...
  if (textsearch) { 
    ...
    sb.append(academic).append(' ').append(peerage).append(' ')
      .append(firstname).append(' ').append(prefix).append(' ')
      .append(surname).append(NL);
    return sb.toString();
    }
  return "";
  }
...
public final boolean isValid()
  {
  if ((firstname=firstname.trim()).length() ==0) { firstname = callname; }
  if ((callname=callname.trim()).length() ==0) { callname = firstname; }
  if (((firstname=firstname.trim()).length() ==0) && 
...
public final Object clone()
  {
  MCRMetaPersonName out = new MCRMetaPersonName(datapart,subtag,lang,type,
    inherited,firstname,callname,surname,fullname,academic,peerage,prefix);
  return (Object)out;
  }
