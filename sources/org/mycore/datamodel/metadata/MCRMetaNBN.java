 ...
 * of a metadata object. The MCRMetaNBN class present a single item,
 * which holds a NBN.
 *
 ...
 */
public MCRMetaNBN(String set_datapart, String set_subtag, 
  int set_inherted, String set_nbn) throws MCRException
  {
  super(set_datapart,set_subtag,"de","",set_inherted);
  nbn = "";
  if (set_nbn != null) { nbn = set_nbn.trim(); }
  }

/**
 * This method set the NBN.
 *
 * @param set_nbn        the new NBN string
 **/
