...
public class MCRMetaLink extends MCRMetaDefault implements MCRMetaInterface {
     ...
     */
    public void setReference(String set_href, String set_label, String set_title)
            throws MCRException {
        linktype = "locator";
    ...
    public void setFromDOM(org.jdom.Element element) throws MCRException {
        ...
        super.type = "";
        String temp = element.getAttributeValue("type", org.jdom.Namespace
    ...
    public org.jdom.Element createXML() throws MCRException {
        ...
        elm.setAttribute("type", linktype, org.jdom.Namespace.getNamespace(
                "xlink", MCRDefaults.XLINK_URL));
        if (linktype.equals("locator")) {
            elm.setAttribute("href", href, org.jdom.Namespace.getNamespace(
                    "xlink", MCRDefaults.XLINK_URL));
            if ((label != null) && ((label = label.trim()).length() != 0)) {
                elm.setAttribute("label", label, org.jdom.Namespace
                        .getNamespace("xlink", MCRDefaults.XLINK_URL));
            }
            if ((title != null) && ((title = title.trim()).length() != 0)) {
                elm.setAttribute("title", title, org.jdom.Namespace
                        .getNamespace("xlink", MCRDefaults.XLINK_URL));
            }
        } else {
            elm.setAttribute("from", from, org.jdom.Namespace.getNamespace(
                    "xlink", MCRDefaults.XLINK_URL));
