...
/**
 * This class implements all method for handling with the MCRMetaDate part of a
 * metadata object. The MCRMetaDate class present a single item, which has pair
 * of a date and his corresponding optional type. The date is stored as
 * GregorianCalendar.
 * 
...
final public class MCRMetaDate extends MCRMetaDefault implements MCRMetaInterface {
     ...
     * @exception MCRException if the set_subtag value is null or empty
     */
    public MCRMetaDate(String set_datapart, String set_subtag, String default_lang, String set_type, int set_inherted, String set_date) throws MCRException {
        super(set_datapart, set_subtag, default_lang, set_type, set_inherted);
        setDate(set_date);
    }
     ...
     */
    public final void set(String set_lang, String set_type, GregorianCalendar set_date) {
        setLang(set_lang);
        setType(set_type);
     ...
     * the MyCoRe XML MCRMetaDate definition for the given subtag.
     * 
     * @exception MCRException
