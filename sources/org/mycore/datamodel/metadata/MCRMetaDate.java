 ...
 */
final public class MCRMetaDate extends MCRMetaDefault implements
        MCRMetaInterface {
    // common data
     ...
     */
    public final void set(String set_lang, String set_type,
            GregorianCalendar set_date) {
        setLang(set_lang);
        setType(set_type);
        if (set_date != null) {
            date = set_date;
    ...
    public final Object clone() {
        MCRMetaDate out = new MCRMetaDate(datapart, subtag, lang, type,
                inherited, date);
        return (Object) out;
    }
}
