...
public class MCRMetaISBN extends MCRMetaDefault implements MCRMetaInterface {
	 ...
	 */
	public MCRMetaISBN(String set_datapart, String set_subtag,
			int set_inherted, String set_isbn) throws MCRException {
	...
	public boolean isValid() {
		...
		if ((isbn == null) || invalid || (isbn.length() == 0)
				|| (sum2 % 11 > 0)) {
			return false;
		}
		return true;
