...
/**
 * This class implements all methods for handling with the MCRMetaInstitutionName part
 * of a metadata object. The MCRMetaInstitutionName class represents a name of
 ...
 **/
public MCRMetaInstitutionName(String set_datapart, String set_subtag, 
  String default_lang, String set_type, int set_inherted, String set_fullname, 
 ...
 * @param set_property    the property title
 **/
public final void set(String set_fullname, String set_nickname,  
  String set_property)
  {
  if ((set_fullname    == null) || (set_nickname == null) ||
      (set_property    == null))   {
 ...
 * by the MyCoRe XML MCRMetaInstitutionName definition for the given subtag.
 *
...
public final Object clone()
  {
  MCRMetaInstitutionName out = new MCRMetaInstitutionName(datapart,subtag,lang,
    type,inherited,fullname,nickname,property);
  return (Object) out;
  }
