 ...
 */
final public class MCRMetaInstitutionName extends MCRMetaDefault implements
		MCRMetaInterface {
	...
	public MCRMetaInstitutionName(String set_datapart, String set_subtag,
			...
			String set_fullname, String set_nickname, String set_property)
			throws MCRException {
	...
	public final org.jdom.Element createXML() throws MCRException {
		if (!isValid()) {
			throw new MCRException(
					"The content of MCRMetaInstitutionName is not valid.");
		}
		...
		if ((nickname = nickname.trim()).length() != 0) {
			elm.addContent((Content) new org.jdom.Element("nickname")
					.addContent(nickname));
		}
		if ((property = property.trim()).length() != 0) {
			elm.addContent((Content) new org.jdom.Element("property")
					.addContent(property));
		}
		return elm;
	}
	...
	public final Object clone() {
		MCRMetaInstitutionName out = new MCRMetaInstitutionName(datapart,
				subtag, lang, type, inherited, fullname, nickname, property);
		return (Object) out;
	}
