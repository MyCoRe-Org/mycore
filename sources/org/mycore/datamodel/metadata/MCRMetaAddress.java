 ...
 */
final public class MCRMetaAddress extends MCRMetaDefault implements
        MCRMetaInterface, Cloneable {
    ...
    public MCRMetaAddress(String set_datapart, String set_subtag,
            ...
            String set_country, String set_state, String set_zipcode,
            String set_city, String set_street, String set_number)
            throws MCRException {
    ...
    public final void set(String set_country, String set_state,
            String set_zipcode, String set_city, String set_street,
            String set_number) {
    ...
    public final org.jdom.Element createXML() throws MCRException {
        if (!isValid()) {
            throw new MCRException(
                    "The content of MCRMetaAddress is not valid.");
        }
        ...
        if ((country = country.trim()).length() != 0) {
            elm.addContent((Content) new org.jdom.Element("country")
                    .addContent(country));
        }
        if ((state = state.trim()).length() != 0) {
            elm.addContent((Content) new org.jdom.Element("state")
                    .addContent(state));
        }
        if ((zipcode = zipcode.trim()).length() != 0) {
            elm.addContent((Content) new org.jdom.Element("zipcode")
                    .addContent(zipcode));
        }
        if ((city = city.trim()).length() != 0) {
            elm.addContent((Content) new org.jdom.Element("city")
                    .addContent(city));
        }
        if ((street = street.trim()).length() != 0) {
            elm.addContent((Content) new org.jdom.Element("street")
                    .addContent(street));
        }
        if ((number = number.trim()).length() != 0) {
            elm.addContent((Content) new org.jdom.Element("number")
                    .addContent(number));
        }
        return elm;
    }
