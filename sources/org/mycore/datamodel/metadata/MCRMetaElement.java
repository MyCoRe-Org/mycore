...
public class MCRMetaElement {
     ...
     */
    public MCRMetaElement(String set_lang, String set_classname,
            String set_tag, boolean set_parasearch, boolean set_textsearch,
            boolean set_hreitable, boolean set_notinherit, ArrayList set_list) {
    ...
    public void setParametricSearch(String parasearch) {
        ...
        if ((parasearch == null)
                || ((parasearch = parasearch.trim()).length() == 0)) {
            return;
        }
    ...
    public void setTextSearch(String textsearch) {
        ...
        if ((textsearch == null)
                || ((textsearch = textsearch.trim()).length() == 0)) {
            return;
        }
    ...
    public void setHeritable(String heritable) {
        ...
        if ((heritable == null)
                || ((heritable = heritable.trim()).length() == 0)) {
            return;
        }
    ...
    public void setNotInherit(String notinherit) {
        ...
        if ((notinherit == null)
                || ((notinherit = notinherit.trim()).length() == 0)) {
            return;
        }
    ...
    public final String createTextSearch(boolean flag) throws MCRException {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            sb.append(
                    ((MCRMetaInterface) list.get(i))
                            .createTextSearch(textsearch)).append(' ');
        }
        return sb.toString();
    }
    ...
    public final Object clone() {
        ...
        for (int i = 0; i < size(); i++) {
            MCRMetaInterface mif = (MCRMetaInterface) (((MCRMetaInterface) list
                    .get(i)).clone());
