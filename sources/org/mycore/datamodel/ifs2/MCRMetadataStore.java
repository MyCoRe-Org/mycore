...
public class MCRMetadataStore extends MCRStore {
    ...
    /**
     * A cache of retrieved metadata objects. Cache size can be configured by
     * property MCR.IFS2.MetadataStore.<TYPE>.CacheSize, and may be 0 for
     * disabling the cache.
     */
     ...
     * @param the
     *            cache size, to disable cache use a size of 0.
     */
     ...
     * @throws Exception
     *             when the given ID is already used for another stored document
     */
     ...
     *            the XML document to be stored
     * @param id
     *            the ID that should be replaced
     * @throws Exception
     *             when the given ID is not used by any existing document
     */
     ...
     * 
     * @param xml
     *            the document to be written to file
     * @param fo
     *            the file the document should be written to
     */
    ...
    /**
     * Returns the XML document stored under the given ID. The result eventually
     * comes from a cache, so you must not modify it, unless you request a copy
     * of the cached version
     * 
     * @param id
     *            the ID of the XML document
     * @param copy
     *            if true, make a copy of potentially cached version
     * @return the XML document stored under that ID, or null when there is no
     *         such document
     */
    ...
    /**
     * Returns the time of last modification of the XML document with the given
     * ID.
     * 
     * @param id
     *            the ID of the stored XML document
     * @return the time that document was last modified in the store, or null
