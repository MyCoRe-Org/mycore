...
/**
 * Additionally commits each change of metadata in the store to a subversion
 * repository. Allows external changes of metadata in the repository, and
 * provides a method to update to the HEAD revision afterwards. Provides method
 * to retrieve all versions stored for a given ID.
 * 
...
public class MCRVersioningMetadataStore extends MCRMetadataStore {
     ...
     * 
     * @param id
     *            the ID of the metadata document that should be updated
     */
    ...
    public void updateAll() throws Exception {
        ...
        while (ids.hasMoreElements())
            update(ids.nextElement());
    }

    /**
     * Retrieves a list of all stored versions for the given metadata document
     * ID
     * 
