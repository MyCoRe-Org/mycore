 ...
 * Adaption and extension for the MyCoRe Open Source System by
 * Detlev Degenhardt, Detlev.Degenhardt@rz.uni-freiburg.de
 *
...
{
  private MCRCrypt() {} // defined so class can't be instantiated.
   ...
   * @return           A string consisting of the 2-character salt followed by the encrypted string.
   */
  ...
  /**
   * This method encrypts a string given the cleartext string. A random salt is
   * generated using java.util.Random.
   *
   * @param original  The string to be encrypted.
  ...
  public static final String crypt(String original)
  {
    ...
    salt = (new StringBuffer()).append(chars[Math.abs(randomGenerator.nextInt()) % numSaltChars])
                               .append(chars[Math.abs(randomGenerator.nextInt()) % numSaltChars]).toString();
