...
public interface MCRUserStore {
     ...
     */
    public void createPrivilegeSet(MCRPrivilegeSet privilegeSet)
            throws MCRException;
     ...
     */
    public ArrayList getGroupIDsWithAdminUser(String userID)
            throws MCRException;
     ...
     */
    public ArrayList getUserIDsWithPrimaryGroup(String groupID)
            throws MCRException;
