...
public class MCRUserContact {
	private static Logger logger = Logger.getLogger(MCRUserContact.class
			.getName());
	...
	public MCRUserContact(String salutation, String firstname, String lastname,
			...
			String state, String institution, String faculty,
			String department, String institute, String telephone, String fax,
	...
	public Object clone() {
		return new MCRUserContact(this.salutation, this.firstname,
				this.lastname, this.street, this.city, this.postalcode,
				this.country, this.state, this.institution, this.faculty,
				this.department, this.institute, this.telephone, this.fax,
	...
	public final void setFromJDOMElement(org.jdom.Element elm) {
		...
		this.salutation = MCRUserObject.trim(elm
				.getChildTextTrim("contact.salutation"), salutation_len);
		this.firstname = MCRUserObject.trim(elm
				.getChildTextTrim("contact.firstname"), firstname_len);
		this.lastname = MCRUserObject.trim(elm
				.getChildTextTrim("contact.lastname"), lastname_len);
		this.street = MCRUserObject.trim(
				elm.getChildTextTrim("contact.street"), street_len);
		this.city = MCRUserObject.trim(elm.getChildTextTrim("contact.city"),
				city_len);
		this.postalcode = MCRUserObject.trim(elm
				.getChildTextTrim("contact.postalcode"), postalcode_len);
		this.country = MCRUserObject.trim(elm
				.getChildTextTrim("contact.country"), country_len);
		this.state = MCRUserObject.trim(elm.getChildTextTrim("contact.state"),
				state_len);
		this.institution = MCRUserObject.trim(elm
				.getChildTextTrim("contact.institution"), institution_len);
		this.faculty = MCRUserObject.trim(elm
				.getChildTextTrim("contact.faculty"), faculty_len);
		this.department = MCRUserObject.trim(elm
				.getChildTextTrim("contact.department"), department_len);
		this.institute = MCRUserObject.trim(elm
				.getChildTextTrim("contact.institute"), institute_len);
		this.telephone = MCRUserObject.trim(elm
				.getChildTextTrim("contact.telephone"), telephone_len);
		...
		this.email = MCRUserObject.trim(elm.getChildTextTrim("contact.email"),
				email_len);
		this.cellphone = MCRUserObject.trim(elm
				.getChildTextTrim("contact.cellphone"), cellphone_len);
	}
	...
	public final org.jdom.Element toJDOMElement() {
		...
		org.jdom.Element Salutation = new org.jdom.Element("contact.salutation")
				.setText(salutation);
		org.jdom.Element Firstname = new org.jdom.Element("contact.firstname")
				.setText(firstname);
		org.jdom.Element Lastname = new org.jdom.Element("contact.lastname")
				.setText(lastname);
		org.jdom.Element Street = new org.jdom.Element("contact.street")
				.setText(street);
		org.jdom.Element City = new org.jdom.Element("contact.city")
				.setText(city);
		org.jdom.Element Postalcode = new org.jdom.Element("contact.postalcode")
				.setText(postalcode);
		org.jdom.Element Country = new org.jdom.Element("contact.country")
				.setText(country);
		org.jdom.Element State = new org.jdom.Element("contact.state")
				.setText(state);
		org.jdom.Element Institution = new org.jdom.Element(
				"contact.institution").setText(institution);
		org.jdom.Element Faculty = new org.jdom.Element("contact.faculty")
				.setText(faculty);
		org.jdom.Element Department = new org.jdom.Element("contact.department")
				.setText(department);
		org.jdom.Element Institute = new org.jdom.Element("contact.institute")
				.setText(institute);
		org.jdom.Element Telephone = new org.jdom.Element("contact.telephone")
				.setText(telephone);
		org.jdom.Element Fax = new org.jdom.Element("contact.fax").setText(fax);
		org.jdom.Element Email = new org.jdom.Element("contact.email")
				.setText(email);
		org.jdom.Element Cellphone = new org.jdom.Element("contact.cellphone")
				.setText(cellphone);

		// Aggregate address element
		address.addContent(Salutation).addContent(Firstname).addContent(
				Lastname).addContent(Street).addContent(City).addContent(
				Postalcode).addContent(Country).addContent(State).addContent(
				Institution).addContent(Faculty).addContent(Department)
				.addContent(Institute).addContent(Telephone).addContent(Fax)
				.addContent(Email).addContent(Cellphone);
		return address;
	}
