...
public class MCRLanguageDetector {
    ...
    static {
        words.put("de", "als am auch auf aus bei bis das dem den der deren derer des dessen die dies diese dieser dieses ein eine einer eines einem f�r hat im ist mit sich Sie �ber und vom von vor wie zu zum zur");
        words.put("en", "a and are as at do for from has have how its like new of on or the their through to with you your");
        words.put("fr", "la le les un une des, � aux de pour par sur comme aussi jusqu'� jusqu'aux quel quels quelles laquelle lequel lesquelles lesquelles auxquels auxquelles avec sans ont sont duquel desquels desquelles quand");
        ...
        endings.put("fr", "�, �s, �e, �es, euse, euses, �me, euil, asme, isme, aux");
    }
