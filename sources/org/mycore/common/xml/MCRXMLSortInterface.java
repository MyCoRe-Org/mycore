...
public interface MCRXMLSortInterface {
	...
	/**
	 * Adds a key as a sort criteria.
	 * Sorting order in this case should always be <code>INORDER</code>. The
	 * implementation of this Interface must also know how to handle the Object.
	 * 
	 * @return				must return itself
	 * @param	sortKey		Key for sorting
	 * @throws	MCRException	if doesn't know how to handle
	 * 							<code>sortKey</code>
	...
	/**
	 * Adds a key as a sort criteria with a specified sorting order.
	 * The implementation of this Interface must know how to handle the Object.
	 * 
	 * @return				must return itself
	 * @param	sortKey		Key for sorting
	...
	/**
	 * Adds an array of Objects to be sorted.
	 * The implementation of this Interface must know how to handle each Object.
	 * 
	 * @return				must return itself
	 * @throws	MCRException	if doesn't know how to handle
	 * 							<code>sortObjects</code>
	 * @param	sortObjects	Objects to be sorted
	 * @author Thomas Scheffler
	 */
	public MCRXMLSortInterface add(Object[] sortObjects) throws MCRException;
	/**
	 * Adds an Object to be sorted.
	 * The implementation of this Interface must know how to handle each Object.
	 * 
	 * @return				must return itself
	 * @throws	MCRException	if doesn't know how to handle
	 * 							<code>sortObject</code>
	 * @param	sortObject	Objects to be sorted
	 * @author Thomas Scheffler
	 */
	 ...
	 * 
	 * @return	Object[]	sorted Array of Objects.
	 * @param	reversed	true if given sorting Order should be reversed
	 * @throws	MCRException	if sorting fails
	 * @author Thomas Scheffler
	 */
