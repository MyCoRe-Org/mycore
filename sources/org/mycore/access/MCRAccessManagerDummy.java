 ...
 * 
 */
public class MCRAccessManagerDummy implements MCRAccessInterface {

    private static MCRAccessManagerDummy singleton;

    /** the logger */
    static Logger logger = Logger.getLogger(MCRAccessManagerDummy.class.getName());

    public MCRAccessManagerDummy() {
    }
     ...
     */
    public synchronized MCRAccessManagerDummy instance() {
        if (singleton == null) {
            singleton = new MCRAccessManagerDummy();
        }
    ...
    public void addRule(MCRObjectID id, String pool, org.jdom.Element rule) throws MCRException {
        logger.debug("Execude MCRAccessManagerDummy addRule");
    }
    ...
    public void removeRule(MCRObjectID id, String pool) throws MCRException {
        logger.debug("Execude MCRAccessManagerDummy removeRule");
    ...
    public void removeAllRules(MCRObjectID id) throws MCRException {
        logger.debug("Execude MCRAccessManagerDummy removeAllRules");
    ...
    public void updateRule(MCRObjectID id, String pool, org.jdom.Element rule) throws MCRException {
        logger.debug("Execude MCRAccessManagerDummy updateRule");
    ...
    public boolean checkAccess(MCRObjectID id, String pool) {
        logger.debug("Execude MCRAccessManagerDummy checkAccess");
        return true;
    }
}
