 ...
 * (creates sql tables, run queries
 *  
 * @author   Arne Seifert
 **/
...
public class MCRAccessCtrlCommands extends MCRAbstractCommands {
    ...
    public MCRAccessCtrlCommands(){
        ...
        com = new MCRCommand("get ruleid for objectid {0} in pool {1}",
    ...
    /**
     * This method returns the ruleid as string for a given object and accesspool
     * 
