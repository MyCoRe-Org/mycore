...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <xsl:variable name="heading">
    ...
    <xsl:value-of select="/mcr_user/user/@ID"/> </xsl:variable>
    ...
    <xsl:choose>
      <xsl:when test="$direction = 'rtl' ">
        <table cellpadding="0" cellspacing="0">
          ...
          <tr>
            <th class="metahead" colspan="2">
              <xsl:copy-of select="i18n:translate('component.userlogin.contact.contact')"/>
            </th>
          </tr>
          <tr>
            <td class="metavalue-rtl">
      ...
      <xsl:otherwise>
        ...
        <table cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.numID')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/@numID"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.status')"/>:</td>
            <xsl:choose>
              <xsl:when test="./user/@id_enabled='true'">
                <td class="metavalue">
                  <xsl:value-of select="i18n:translate('component.userlogin.contact.enabled')"/>
          ...
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.update')"/>:</td>
            <xsl:choose>
              <xsl:when test="./user/@update_allowed='true'">
                <td class="metavalue">
                  <xsl:value-of select="i18n:translate('component.userlogin.contact.allowed')"/>
          ...
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.creator')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.creator"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.creationDate')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.creation_date"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.lastModified')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.last_modified"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.description')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.description"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.primaryGroup')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.primary_group"/>
            </td>
          </tr>
          ...
          <tr>
            <xsl:variable name="numGroups" select="count(./user/user.groups/groups.groupID)"/>
            <td class="metaname">
              <xsl:copy-of select="i18n:translate('component.userlogin.contact.groups')"/>:</td>
            <td class="metavalue">
              <xsl:for-each select="./user/user.groups/groups.groupID">
                <xsl:value-of select="."/>
                <br/>
          ...
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.salutation')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.salutation"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.firstName')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.firstname"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.lastName')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.lastname"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.street')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.street"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.city')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.city"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.postalCode')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.postalcode"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.country')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.country"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.state')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.state"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.institution')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.institution"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.faculty')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.faculty"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.department')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.department"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.institute')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.institute"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.telefon')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.telephone"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.fax')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.fax"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.email')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.email"/>
            </td>
          </tr>
          <tr>
            <td class="metaname">
              <xsl:value-of select="i18n:translate('component.userlogin.contact.cell')"/>:</td>
            <td class="metavalue">
              <xsl:value-of select="./user/user.contact/contact.cellphone"/>
            </td>
          </tr>
