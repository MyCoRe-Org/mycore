...
import {AltoChapter} from "../../components/MyCoReHighlightAltoComponent";
 ...
 */
export class HighlightAltoChapterCanvasPageLayer implements CanvasPageLayer {

    public selectedChapter: AltoChapter = null;
    public highlightedChapter: AltoChapter = null;
    public fadeAnimation: InterpolationAnimation = null;

    private chaptersToClear: MyCoReMap<string, AltoChapter> = new MyCoReMap<string, AltoChapter>();
    ...
    private isLinkedWithoutBlocks(fileID: string): boolean {
        return !this.chaptersToClear.filter((id: string, area: AltoChapter) => {
