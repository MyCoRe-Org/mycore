...
public class MCRSolrPathDocumentFactory {
    ...
    public static MCRSolrPathDocumentFactory obtainInstance() {
        return MCRConfiguration2.getSingleInstanceOfOrThrow(MCRSolrPathDocumentFactory.class, SOLR_CONFIG_PREFIX);
    }

    public static MCRSolrPathDocumentFactory createInstance() {
        return MCRConfiguration2.getInstanceOfOrThrow(MCRSolrPathDocumentFactory.class, SOLR_CONFIG_PREFIX);
    }
