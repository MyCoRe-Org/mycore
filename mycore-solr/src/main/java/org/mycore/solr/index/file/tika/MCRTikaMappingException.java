...
public class MCRTikaMappingException extends Exception {
    ...
    public MCRTikaMappingException(String message) {
        super(message);
    }

    public MCRTikaMappingException(String message, Throwable cause) {
        super(message, cause);
    }

    public MCRTikaMappingException(Throwable cause) {
        super(cause);
    }
