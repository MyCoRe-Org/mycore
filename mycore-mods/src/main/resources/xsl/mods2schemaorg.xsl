...
>
  ...
  <xsl:template match="mods:mods[mods:classification/@valueURI='http://schema.org/Book']">
    <fn:map>
      <xsl:call-template name="modsBook"/>
    </fn:map>
  </xsl:template>

  <xsl:template match="mods:mods[mods:classification/@valueURI='http://schema.org/Thesis']">
    <fn:map>
      <xsl:call-template name="modsThesis"/>
    </fn:map>
  </xsl:template>

  <xsl:template match="mods:mods[mods:classification/@valueURI='http://schema.org/Course']">
    <fn:map>
      <xsl:call-template name="modsCourse"/>
    </fn:map>
  </xsl:template>

  <!-- Base type for mods. Every object is a CreativeWork! -->
  <xsl:template name="modsCreativeWork">
    <xsl:param name="context" select="'http://schema.org/'"/> <!-- used for inheritance -->
    <xsl:param name="type" select="'CreativeWork'"/> <!-- used for inheritance -->
  ...
  <xsl:template name="modsScholarlyArticle">
    ...
    <xsl:param name="type" select="'ScholarlyArticle'"/>
    <xsl:call-template name="modsArticle">
  ...
  <xsl:template name="modsArticle">
    <xsl:param name="context" select="'http://schema.org/'"/> <!-- used for inheritance -->
    <xsl:param name="type" select="'Article'"/> <!-- used for inheritance -->
    <xsl:call-template name="modsCreativeWork">
      <xsl:with-param name="context" select="$context"/>
      <xsl:with-param name="type" select="$type"/>
    </xsl:call-template>
  ...
  <xsl:template name="modsBook">
    <xsl:param name="context" select="'http://schema.org/'"/> <!-- used for inheritance -->
    <xsl:param name="type" select="'Book'"/> <!-- used for inheritance -->
    <xsl:call-template name="modsCreativeWork">
      <xsl:with-param name="context" select="$context"/>
      <xsl:with-param name="type" select="$type"/>
    </xsl:call-template>
  ...
  <xsl:template name="modsThesis">
    <xsl:param name="context" select="'http://schema.org/'"/> <!-- used for inheritance -->
    <xsl:param name="type" select="'Thesis'"/> <!-- used for inheritance -->
    <xsl:call-template name="modsCreativeWork">
      <xsl:with-param name="context" select="$context"/>
      <xsl:with-param name="type" select="$type"/>
    </xsl:call-template>
  ...
  <xsl:template name="modsCourse">
    <xsl:param name="context" select="'http://schema.org/'"/> <!-- used for inheritance -->
    <xsl:param name="type" select="'Course'"/> <!-- used for inheritance -->
    <xsl:call-template name="modsCreativeWork">
      <xsl:with-param name="context" select="$context"/>
      <xsl:with-param name="type" select="$type"/>
    </xsl:call-template>
