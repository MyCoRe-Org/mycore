  ...
  <xsl:template match="mods:mods">
    ...
    <xsl:choose>
      <xsl:when test="mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher">
        <xsl:apply-templates select="mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher" mode="print_publisher_field" />
      </xsl:when>
      <xsl:when test="mods:relatedItem[@type='host']/mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher">
        <xsl:apply-templates select="mods:relatedItem[@type='host']/mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher" mode="print_publisher_field" />
      </xsl:when>
      <xsl:when test="//mods:relatedItem[@type='host']/mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher">
        <xsl:apply-templates select="//mods:relatedItem[@type='host']/mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher" mode="print_publisher_field" />
      </xsl:when>
      <xsl:when test="mods:relatedItem[@type='series']/mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher">
        <xsl:apply-templates select="mods:relatedItem[@type='series']/mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher" mode="print_publisher_field" />
      </xsl:when>
      <xsl:when test="//mods:relatedItem[@type='series']/mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher">
        <xsl:apply-templates select="//mods:relatedItem[@type='series']/mods:originInfo[not(@eventType) or @eventType='publication']/mods:publisher" mode="print_publisher_field" />
      </xsl:when>
