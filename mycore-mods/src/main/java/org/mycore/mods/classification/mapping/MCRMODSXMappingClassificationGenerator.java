 ...
 * in all categories already present in the MODS document.
 * <p>
 * For each category ID in MODS document, if the corresponding category has a <code>x-mapping</code>-label,
