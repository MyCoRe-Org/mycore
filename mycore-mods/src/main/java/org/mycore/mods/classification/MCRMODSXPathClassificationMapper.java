...
import org.mycore.common.events.MCRXPathClassificationMapperBase;
...
/**
 * A {@link MCRMODSXMappingClassificationMapper} is a {@link Mapper} that looks for mapping information
 * for a given list of classifications, by checking if XPaths configured for categories of such classifications
 * match the MODS document.
 * <p>
 ...
 * <ul>
 * <li> The property suffix {@link MCRXPathClassificationMapperBase#CLASSIFICATION_IDS_KEY} can be used to
...
public class MCRMODSXPathClassificationMapper
    extends MCRXPathClassificationMapperBase<MCRMODSWrapper, Mapping>
    implements Mapper {
    ...
    @Override
    protected Mapping toMappedValue(XPathMapping mapping) {
        ...
        return new Mapping(generator, targetCategoryId);
    }
