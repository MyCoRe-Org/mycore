...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="mods:mods">
    <work:work visibility="public" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.orcid.org/ns/work /work-3.0.xsd "> <!-- TODO visibility -->
