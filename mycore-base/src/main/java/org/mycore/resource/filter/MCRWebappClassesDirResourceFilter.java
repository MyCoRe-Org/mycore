 ...
 * <p>
 * <em>Unless placed there manually, such resources originate from the <code>/WEB-INF/classes</code> directory inside the
 * WAR file. In a usual build, such resources originate from the <code>/src/main/resources</code> directory inside the
 * Maven project that creates the WAR file.</em>
 * <p>
