...
/**
 * Helper class to collect output an external process has written to STDOUT/STDERR, 
 * using a separate thread.
 *  
 * @author Frank L\u00FCtzenkirchen
 */
public class MCRStreamSucker extends Thread
{
  ...
  /**
   * Returns all output read from the input stream
   */
  public MCRContent getContent() throws Exception
  {
    return MCRContent.readFrom( out.toByteArray() );
  }
}
