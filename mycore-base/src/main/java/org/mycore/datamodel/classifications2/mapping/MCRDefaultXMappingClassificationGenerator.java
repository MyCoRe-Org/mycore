 ...
 * in all categories already present in the default metadata document.
 * <p>
 * For each category ID in the metadata document, if the corresponding category has a <code>x-mapping</code>-label,
 * the content of that label is used to obtain additional category IDs using an {@link Evaluator}.
 * </p>
