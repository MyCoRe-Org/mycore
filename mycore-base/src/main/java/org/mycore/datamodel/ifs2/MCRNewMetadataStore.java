...
public abstract class MCRNewMetadataStore {
    ...
    protected MCRNewMetadataStore(MCRStoreConfig storeConfig) {
        ...
        if (hasWorkDir) {
            workDir = getDirectory(configPrefix + ".WorkDir");
        } else {
            workDir = null;
        }
    ...
    public MCRNewMetadata create(MCRContent content) throws MCRPersistenceException {
        return create(getNextFreeID(), content);
    }

    public MCRNewMetadata create(int id, MCRContent content) throws MCRPersistenceException {
    ...
    public MCRNewMetadata update(int id, MCRContent content) throws MCRPersistenceException {
        MCRNewMetadata metadata = new MCRNewMetadata(this, id);
    ...
    public MCRAbstractMetadataVersion<?> getVersion(int id, String revision)
        throws MCRPersistenceException, MCRUsageException {
        return getVersion(new MCRNewMetadata(this, id, revision));
    }

    public abstract MCRAbstractMetadataVersion<?> getVersion(MCRNewMetadata metadata)
        throws MCRPersistenceException, MCRUsageException;

    public MCRAbstractMetadataVersion<?> getVersionFirst(int id) throws MCRPersistenceException, MCRUsageException {
        return getVersionFirst(new MCRNewMetadata(this, id));
    }

    public MCRAbstractMetadataVersion<?> getVersionFirst(MCRNewMetadata metadata)
        throws MCRPersistenceException, MCRUsageException {
        String firstRevision = getVersions(metadata)
            .sequential()
    ...
    public MCRAbstractMetadataVersion<?> getVersionLast(MCRNewMetadata metadata)
        throws MCRPersistenceException, MCRUsageException {
        String firstRevision = getVersions(metadata)
            .sequential()
    ...
    public Stream<MCRAbstractMetadataVersion<?>> getVersions(int id) throws MCRPersistenceException, MCRUsageException {
        return getVersions(new MCRNewMetadata(this, id));
    }

    public abstract Stream<MCRAbstractMetadataVersion<?>> getVersions(MCRNewMetadata metadata)
        throws MCRPersistenceException, MCRUsageException;
