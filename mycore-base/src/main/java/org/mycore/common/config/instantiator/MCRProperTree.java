...
public final class MCRProperTree {
    ...
    private static final MCRProperTree EMPTY = empty();
    ...
    public boolean isEmpty() {
        return value == null && nested.isEmpty();
    }
    ...
    public static MCRProperTree empty() {
        return new MCRProperTree(null, Map.of());
    }
        ...
        for (Map.Entry<String, String> entry : properties.entrySet()) {
            ...
            if (!value.isBlank()) {
                ...
                if (key.isEmpty()) {
                    ...
                    ((Map<String, Object>) current.computeIfAbsent(lastKeyPart, HASH_MAP)).put(null, trimmedValue);
                }
            }
        }
        return root;
