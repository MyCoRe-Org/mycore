...
/**
 * Represents an extract of properties (typically {@link MCRConfiguration2#getAllPropertiesMap()}) used to
...
public final class MCRInstanceConfiguration<S> {
     ...
     * uses {@link MCRConfiguration2#getAllPropertiesMap()} as the properties.
     */
    public static <S> MCRInstanceConfiguration<S> ofClassName(Class<S> superClass, String className,
        String prefix) {
        return ofClassName(superClass, className, prefix, MCRConfiguration2.getAllPropertiesMap());
    }
    ...
    public static <S> MCRInstanceConfiguration<S> ofClass(Class<S> superClass, Class<? extends S> valueClass,
        String prefix) {
        return ofClass(superClass, valueClass, prefix, MCRConfiguration2.getAllPropertiesMap());
    }
     ...
     * uses {@link MCRConfiguration2#getAllPropertiesMap()} as the properties and
     * uses {@link Options#NONE} as the options.
     */
    public static <T> MCRInstanceConfiguration<T> ofName(Class<T> superClass, String name) {
        return ofName(superClass, MCRInstanceName.of(name), MCRConfiguration2.getAllPropertiesMap(), Options.NONE);
    }
    ...
    public static <T> MCRInstanceConfiguration<T> ofName(Class<T> superClass, String name,
        Set<Option> options) {
        return ofName(superClass, MCRInstanceName.of(name), MCRConfiguration2.getAllPropertiesMap(), options);
    }
