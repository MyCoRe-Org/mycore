 ...
 * a list of {@link Class} values from the configuration properties.
 * <p>
...
@Inherited
public @interface MCRClassPropertyList {
    ...
    /**
     * @return true if the at least one sub-property of the property specified by {@link MCRClassPropertyList#name()}
    ...
    /**
     * @return true if the property name specified by {@link MCRClassPropertyList#name()} is absolute and not specific
     * for this instance e.g. <code>MCR.Foo.Bar</code>.
     */
