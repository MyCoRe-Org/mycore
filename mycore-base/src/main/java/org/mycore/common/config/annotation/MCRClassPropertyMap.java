 ...
 * a map of {@link Class} values from the configuration properties.
 * <p>
...
@Inherited
public @interface MCRClassPropertyMap {
    ...
    /**
     * @return true if the property name specified by {@link MCRClassPropertyMap#name()} is absolute and not specific
