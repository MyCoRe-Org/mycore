...
/**
 * A {@link MCRPostConstructionSource} is a {@link MCRSourceBase} that interprets a {@link MCRPostConstruction}.
 */
final class MCRPostConstructionSource extends MCRSourceBase {
    ...
    public MCRSourceType type() {
        return MCRSourceType.POST_CONSTRUCTION;
    }
