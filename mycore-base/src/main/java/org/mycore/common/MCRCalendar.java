...
public class MCRCalendar {
    ...
    public static int[] calculateGregorianDateBorders(String dateString) {
        ...
        if (Strings.CS.contains(dateString, "N. CHR") || Strings.CS.contains(dateString, "V. CHR")) {
            final int positionNChr = Strings.CS.indexOf(dateString, "N. CHR");
            final int positionVChr = Strings.CS.indexOf(dateString, "V. CHR");
            if (positionNChr != -1) {
                if (positionNChr == 0) {
                    start = 7;
                    end = length;
        ...
        } else if (Strings.CS.contains(dateString, "AD") || Strings.CS.contains(dateString, "BC")) {
            final int positionAD = Strings.CS.indexOf(dateString, "AD");
            final int positionBC = Strings.CS.indexOf(dateString, "BC");
            if (positionAD != -1) {
                if (positionAD == 0) {
                    start = 2;
                    end = length;
