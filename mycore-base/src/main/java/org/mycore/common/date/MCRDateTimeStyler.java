 ...
 * {@link DateTimeFormatter#ofLocalizedDateTime(FormatStyle, FormatStyle)}, for format a date.
 * <p>
 * The following configuration options are available:
 * <ul>
 * <li> The property suffix {@link MCRDateTimeStyler#DATE_STYLE_KEY} can be used to
 * specify the date style.
 * <li> The property suffix {@link MCRDateTimeStyler#TIME_STYLE_KEY} can be used to
 * specify the time style.
 * <li> The property suffix {@link MCRDateTimeStyler#LOCALE_KEY} can be used to
 ...
 * <li> The property suffix {@link MCRDateTimeStyler#TIME_ZONE_KEY}can be used to
...
public final class MCRDateTimeStyler extends MCRInstantFormatterBase {
    ...
    public static final class Factory implements Supplier<MCRDateTimeStyler> {
