...
/**
 * A {@link MCRXMappingClassificationMapper} is a {@link Mapper} that looks for mapping information
 * for a given list of classifications, by checking if XPaths configured for categories of such classifications
 * match the metadata document.
 * <p>
...
public class MCRXPathClassificationMapper
    extends MCRXPathClassificationMapperBase<Document, MCRCategoryID>
    implements Mapper {
