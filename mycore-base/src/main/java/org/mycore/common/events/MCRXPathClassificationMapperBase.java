...
/**
 * {@link MCRXMappingClassificationMapper} is a base implementation for data model specific implementations of
 * {@link Mapper} that looks for mapping information for a given list of classifications, by checking if XPaths
 ...
 * {@link MCRXPathClassificationMapperBase}
 */
public abstract class MCRXPathClassificationMapperBase<I, V> implements Mapper<I, V> {
    ...
    public MCRXPathClassificationMapperBase(List<String> classificationsIds) {
