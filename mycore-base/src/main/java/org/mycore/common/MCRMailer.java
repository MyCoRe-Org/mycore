...
public class MCRMailer extends MCRServlet {
     ...
     */
    private static Document transform(Document input, String stylesheet, Hashtable parameters) throws Exception {
        DOMSource src = MCRLayoutService.instance().doLayout(input, "xsl/" + stylesheet + ".xsl", parameters);
