...
public final class MCRAccessControlSystem extends MCRAccessBaseImpl {
    ...
    private static final Map<String, String> RULE_ID_TABLE = new ConcurrentHashMap<>();
    ...
    public MCRRuleMapping getAutoGeneratedRuleMapping(Element rule, String creator, String pool, String id,
        ...
        String ruleID = RULE_ID_TABLE.get(ruleString);
        if (ruleID == null || ruleID.isEmpty()) {
            ...
            RULE_ID_TABLE.put(ruleString, ruleID);
        }
