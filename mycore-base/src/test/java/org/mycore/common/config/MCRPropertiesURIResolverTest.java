...
public class MCRPropertiesURIResolverTest {
    ...
    public void resolve() {
        ...
        MCRPropertiesResolver resolver = new MCRPropertiesResolver(MCRConfigurationBase.getAllPropertiesMap());
    ...
    public void resolveAll() {
        ...
        MCRConfiguration2.set("Sample.subdir", "%Sample.basedir%/subdir");
        MCRConfiguration2.set("Sample.file", "%Sample.subdir%/file.txt");
        Map<String, String> p = MCRConfigurationBase.getAllPropertiesMap();
