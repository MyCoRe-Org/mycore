...
public class MCRWebappClassesDirResourceFilterTest {
    ...
    public static void prepare() throws IOException {
        ...
        Path basePath = getConfigDirTestBasePath(MCRWebappClassesDirResourceFilterTest.class);

        fooWebappDir = touchFiles(basePath.resolve("foo"));

        nonWebappClassesDirFileUrl = toFileUrl("/foo/bar");
        webappClassesDirFileUrl = toFileUrl(fooWebappDir.resolve("WEB-INF/classes").resolve("foo/bar"));
        libraryUrl = toJarFileUrl("/foo/library.jar", "/foo/bar");
