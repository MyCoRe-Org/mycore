...
public class MCRSyntheticResourceProviderTest {
    ...
    public void provideAbsent(URLStreamHandlerFactory factory) {
        ...
        MCRResourceProvider provider = syntheticProvider(Collections.emptyList());
    ...
    public void providePresent(URLStreamHandlerFactory factory) {
        ...
        MCRResourceProvider provider = syntheticProvider(specs);
    ...
    @MCRTestConfiguration(properties = {
        @MCRTestProperty(key = "Test.Class", classNameOf = MCRSyntheticResourceProvider.class),
    ...
    private static List<URL> toUrlList(List<MCRResourceProvider.ProvidedUrl> providedUrls) {
        return providedUrls.stream().map(MCRResourceProvider.ProvidedUrl::url).toList();
    }
